...
tools_spark_Main._loadClientConfig = function() {
	...
	tools_spark_framework_Assets.addFile("main.skc","config");
...
tools_spark_framework_dom2_$5D_DomEntity2_$5D.prototype = $extend(tools_spark_framework_space2_$5D_core_AEntity2_$5D.prototype,{
	...
	,createInstance: function(p_view2_5D) {
		...
		case "Button":
			...
			v2 = _this2.createElement("button");
	...
	,update: function(p_view2_5D) {
		...
		if(this.gameEntity.getState("NCstyleable") == true) this._updateState("NCstyleable",p_view2_5D);
	...
	,_updateNCstyleable: function(p_NCstyleable,p_view2_5D) {
		...
		if(this.gameEntity.getState("fontSize") != null && this.gameEntity.getState("fontSize") != "Undefined") this._instances.get(p_view2_5D).style.fontSize = this.gameEntity.getState("fontSize");
		if(this.gameEntity.getState("fontColor") != null && this.gameEntity.getState("fontColor") != "Undefined") this._instances.get(p_view2_5D).style.color = this.gameEntity.getState("fontColor");
	...
	,_updateNCmeshType: function(p_NCmeshType,p_view2_5D) {
		...
		case "Input":
			...
			break;
		case "Image":
			this._updateImageProperties(p_view2_5D);
			break;
		case "Undefined":
	...
	,_updateImageProperties: function(p_view2_5D) {
		var l_instance = this._instances.get(p_view2_5D);
		if(this.gameEntity.getState("src") != null && this.gameEntity.getState("src") != "Undefined") {
			var l_asset;
			var key = this.gameEntity.getState("src");
			l_asset = tools_spark_framework_Project.modules.get("DoNotLoad").assets.get(key);
	...
	,_updateButtonProperties: function(p_view2_5D) {
		var l_instance = this._instances.get(p_view2_5D);
		if(this.gameEntity.getState("text") != null && this.gameEntity.getState("text") != "Undefined") l_instance.innerText = this.gameEntity.getState("text");
	}
...
tools_spark_framework_layout_containers_Group.prototype = {
	...
	,updateState: function(p_state) {
		switch(p_state) {
		case "layout":
			if(this.layoutableEntity.getState(p_state) == "Basic") this.set_layout(new tools_spark_framework_layout_layouts_BasicLayout());
...
tools_spark_framework_layout_layouts_BasicLayout.prototype = $extend(tools_spark_framework_layout_layouts_ALayoutBase.prototype,{
	...
	,updateDisplayList: function(p_unscaledWidth,p_unscaledHeight) {
		...
		this.target.width = p_unscaledWidth;
		this.target.height = p_unscaledHeight;
	}
...
tools_spark_sliced_services_std_display_core_Display.prototype = $extend(tools_spark_sliced_core_AService.prototype,{
	...
	,update: function() {
		...
		while(_g < _g1.length) {
			...
			++_g;
			tools_spark_framework_Console.warn("DISPLAY UPDATE: Updating Type: [" + Std.string(f_bufferEntry.type) + "], Name: [" + Std.string(f_bufferEntry.source.getState("name")) + "], State [" + f_bufferEntry.field + "]");
...
tools_spark_sliced_services_std_event_core_Event.prototype = $extend(tools_spark_sliced_core_AService.prototype,{
	...
	,_initPrefabConvertToTypeMap: function() {
		...
		v4;
		var v5 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.MOUSE_LEFT_CLICK;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT_CLICK,v5);
		v5;
		var v6 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.MOUSE_RIGHT_CLICK;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_RIGHT_CLICK,v6);
		v6;
		var v7 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.MOUSE_LEFT_CLICK;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT_CLICKED,v7);
		v7;
		var v8 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.MOUSE_RIGHT_CLICK;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_RIGHT_CLICKED,v8);
		v8;
		var v9 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.MOUSE_ENTERED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_ENTERED,v9);
		v9;
		var v10 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.MOUSE_LEFT;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT,v10);
		v10;
		var v11 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED,v11);
		v11;
		var v12 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED,v12);
		v12;
		var v13 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ALT,v13);
		v13;
		var v14 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSPACE,v14);
		v14;
		var v15 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CAPS_LOCK,v15);
		v15;
		var v16 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CONTROL,v16);
		v16;
		var v17 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DELETE,v17);
		v17;
		var v18 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DOWN,v18);
		v18;
		var v19 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_END,v19);
		v19;
		var v20 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ENTER,v20);
		v20;
		var v21 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ESCAPE,v21);
		v21;
		var v22 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F1,v22);
		v22;
		var v23 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F10,v23);
		v23;
		var v24 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F11,v24);
		v24;
		var v25 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F12,v25);
		v25;
		var v26 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F13,v26);
		v26;
		var v27 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F14,v27);
		v27;
		var v28 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F15,v28);
		v28;
		var v29 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F2,v29);
		v29;
		var v30 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F3,v30);
		v30;
		var v31 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F4,v31);
		v31;
		var v32 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F5,v32);
		v32;
		var v33 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F6,v33);
		v33;
		var v34 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F7,v34);
		v34;
		var v35 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F8,v35);
		v35;
		var v36 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F9,v36);
		v36;
		var v37 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_HOME,v37);
		v37;
		var v38 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_INSERT,v38);
		v38;
		var v39 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFT,v39);
		v39;
		var v40 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_0,v40);
		v40;
		var v41 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_1,v41);
		v41;
		var v42 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_2,v42);
		v42;
		var v43 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_3,v43);
		v43;
		var v44 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_4,v44);
		v44;
		var v45 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_5,v45);
		v45;
		var v46 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_6,v46);
		v46;
		var v47 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_7,v47);
		v47;
		var v48 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_8,v48);
		v48;
		var v49 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_9,v49);
		v49;
		var v50 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ADD,v50);
		v50;
		var v51 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DECIMAL,v51);
		v51;
		var v52 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DIVIDE,v52);
		v52;
		var v53 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ENTER,v53);
		v53;
		var v54 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_MULTIPLY,v54);
		v54;
		var v55 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_SUBTRACT,v55);
		v55;
		var v56 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_DOWN,v56);
		v56;
		var v57 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_UP,v57);
		v57;
		var v58 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHT,v58);
		v58;
		var v59 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SHIFT,v59);
		v59;
		var v60 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SPACE,v60);
		v60;
		var v61 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_TAB,v61);
		v61;
		var v62 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UP,v62);
		v62;
		var v63 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_A,v63);
		v63;
		var v64 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_B,v64);
		v64;
		var v65 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_C,v65);
		v65;
		var v66 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_D,v66);
		v66;
		var v67 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_E,v67);
		v67;
		var v68 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F,v68);
		v68;
		var v69 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_G,v69);
		v69;
		var v70 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_H,v70);
		v70;
		var v71 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_I,v71);
		v71;
		var v72 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_J,v72);
		v72;
		var v73 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_K,v73);
		v73;
		var v74 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_L,v74);
		v74;
		var v75 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_M,v75);
		v75;
		var v76 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_N,v76);
		v76;
		var v77 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_O,v77);
		v77;
		var v78 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_P,v78);
		v78;
		var v79 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Q,v79);
		v79;
		var v80 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_R,v80);
		v80;
		var v81 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_S,v81);
		v81;
		var v82 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_T,v82);
		v82;
		var v83 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_U,v83);
		v83;
		var v84 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_V,v84);
		v84;
		var v85 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_W,v85);
		v85;
		var v86 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_X,v86);
		v86;
		var v87 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Y,v87);
		v87;
		var v88 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Z,v88);
		v88;
		var v89 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_0,v89);
		v89;
		var v90 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_1,v90);
		v90;
		var v91 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_2,v91);
		v91;
		var v92 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_3,v92);
		v92;
		var v93 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_4,v93);
		v93;
		var v94 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_5,v94);
		v94;
		var v95 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_6,v95);
		v95;
		var v96 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_7,v96);
		v96;
		var v97 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_8,v97);
		v97;
		var v98 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_9,v98);
		v98;
		var v99 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_EQUALS,v99);
		v99;
		var v100 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SLASH,v100);
		v100;
		var v101 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSLASH,v101);
		v101;
		var v102 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFTBRACKET,v102);
		v102;
		var v103 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHTBRACKET,v103);
		v103;
		var v104 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKQUOTE,v104);
		v104;
		var v105 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMA,v105);
		v105;
		var v106 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMAND,v106);
		v106;
		var v107 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_MINUS,v107);
		v107;
		var v108 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PERIOD,v108);
		v108;
		var v109 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_QUOTE,v109);
		v109;
		var v110 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SEMICOLON,v110);
		v110;
		var v111 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDMENU,v111);
		v111;
		var v112 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDSEARCH,v112);
		v112;
		var v113 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UNKNOWN,v113);
		v113;
		var v114 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ALT,v114);
		v114;
		var v115 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSPACE,v115);
		v115;
		var v116 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CAPS_LOCK,v116);
		v116;
		var v117 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CONTROL,v117);
		v117;
		var v118 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DELETE,v118);
		v118;
		var v119 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DOWN,v119);
		v119;
		var v120 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_END,v120);
		v120;
		var v121 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ENTER,v121);
		v121;
		var v122 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ESCAPE,v122);
		v122;
		var v123 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F1,v123);
		v123;
		var v124 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F10,v124);
		v124;
		var v125 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F11,v125);
		v125;
		var v126 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F12,v126);
		v126;
		var v127 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F13,v127);
		v127;
		var v128 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F14,v128);
		v128;
		var v129 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F15,v129);
		v129;
		var v130 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F2,v130);
		v130;
		var v131 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F3,v131);
		v131;
		var v132 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F4,v132);
		v132;
		var v133 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F5,v133);
		v133;
		var v134 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F6,v134);
		v134;
		var v135 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F7,v135);
		v135;
		var v136 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F8,v136);
		v136;
		var v137 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F9,v137);
		v137;
		var v138 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_HOME,v138);
		v138;
		var v139 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_INSERT,v139);
		v139;
		var v140 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFT,v140);
		v140;
		var v141 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_0,v141);
		v141;
		var v142 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_1,v142);
		v142;
		var v143 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_2,v143);
		v143;
		var v144 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_3,v144);
		v144;
		var v145 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_4,v145);
		v145;
		var v146 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_5,v146);
		v146;
		var v147 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_6,v147);
		v147;
		var v148 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_7,v148);
		v148;
		var v149 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_8,v149);
		v149;
		var v150 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_9,v150);
		v150;
		var v151 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ADD,v151);
		v151;
		var v152 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DECIMAL,v152);
		v152;
		var v153 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DIVIDE,v153);
		v153;
		var v154 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ENTER,v154);
		v154;
		var v155 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_MULTIPLY,v155);
		v155;
		var v156 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_SUBTRACT,v156);
		v156;
		var v157 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_DOWN,v157);
		v157;
		var v158 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_UP,v158);
		v158;
		var v159 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHT,v159);
		v159;
		var v160 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SHIFT,v160);
		v160;
		var v161 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SPACE,v161);
		v161;
		var v162 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_TAB,v162);
		v162;
		var v163 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UP,v163);
		v163;
		var v164 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_A,v164);
		v164;
		var v165 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_B,v165);
		v165;
		var v166 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_C,v166);
		v166;
		var v167 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_D,v167);
		v167;
		var v168 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_E,v168);
		v168;
		var v169 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F,v169);
		v169;
		var v170 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_G,v170);
		v170;
		var v171 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_H,v171);
		v171;
		var v172 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_I,v172);
		v172;
		var v173 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_J,v173);
		v173;
		var v174 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_K,v174);
		v174;
		var v175 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_L,v175);
		v175;
		var v176 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_M,v176);
		v176;
		var v177 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_N,v177);
		v177;
		var v178 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_O,v178);
		v178;
		var v179 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_P,v179);
		v179;
		var v180 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Q,v180);
		v180;
		var v181 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_R,v181);
		v181;
		var v182 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_S,v182);
		v182;
		var v183 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_T,v183);
		v183;
		var v184 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_U,v184);
		v184;
		var v185 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_V,v185);
		v185;
		var v186 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_W,v186);
		v186;
		var v187 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_X,v187);
		v187;
		var v188 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Y,v188);
		v188;
		var v189 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Z,v189);
		v189;
		var v190 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_0,v190);
		v190;
		var v191 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_1,v191);
		v191;
		var v192 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_2,v192);
		v192;
		var v193 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_3,v193);
		v193;
		var v194 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_4,v194);
		v194;
		var v195 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_5,v195);
		v195;
		var v196 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_6,v196);
		v196;
		var v197 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_7,v197);
		v197;
		var v198 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_8,v198);
		v198;
		var v199 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_9,v199);
		v199;
		var v200 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_EQUALS,v200);
		v200;
		var v201 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SLASH,v201);
		v201;
		var v202 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSLASH,v202);
		v202;
		var v203 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFTBRACKET,v203);
		v203;
		var v204 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHTBRACKET,v204);
		v204;
		var v205 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKQUOTE,v205);
		v205;
		var v206 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMA,v206);
		v206;
		var v207 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMAND,v207);
		v207;
		var v208 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_MINUS,v208);
		v208;
		var v209 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PERIOD,v209);
		v209;
		var v210 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_QUOTE,v210);
		v210;
		var v211 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SEMICOLON,v211);
		v211;
		var v212 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDMENU,v212);
		v212;
		var v213 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDSEARCH,v213);
		v213;
		var v214 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UNKNOWN,v214);
		v214;
	}
...
tools_spark_sliced_services_std_logic_gde_core_GameClassParser.prototype = {
	...
	,_initEventNameToPrefabMap: function() {
		...
		v4;
		var k5 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT_CLICK);
		var v5 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT_CLICK;
		this._xmlEventNameToPrefab.set(k5,v5);
		v5;
		var k6 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_RIGHT_CLICK);
		var v6 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_RIGHT_CLICK;
		this._xmlEventNameToPrefab.set(k6,v6);
		v6;
		var k7 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT_CLICKED);
		var v7 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT_CLICKED;
		this._xmlEventNameToPrefab.set(k7,v7);
		v7;
		var k8 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_RIGHT_CLICKED);
		var v8 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_RIGHT_CLICKED;
		this._xmlEventNameToPrefab.set(k8,v8);
		v8;
		var k9 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_ENTERED);
		var v9 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_ENTERED;
		this._xmlEventNameToPrefab.set(k9,v9);
		v9;
		var k10 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT);
		var v10 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT;
		this._xmlEventNameToPrefab.set(k10,v10);
		v10;
		var k11 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED);
		var v11 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED;
		this._xmlEventNameToPrefab.set(k11,v11);
		v11;
		var k12 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED);
		var v12 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED;
		this._xmlEventNameToPrefab.set(k12,v12);
		v12;
		var k13 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ALT);
		var v13 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ALT;
		this._xmlEventNameToPrefab.set(k13,v13);
		v13;
		var k14 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSPACE);
		var v14 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSPACE;
		this._xmlEventNameToPrefab.set(k14,v14);
		v14;
		var k15 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CAPS_LOCK);
		var v15 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CAPS_LOCK;
		this._xmlEventNameToPrefab.set(k15,v15);
		v15;
		var k16 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CONTROL);
		var v16 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CONTROL;
		this._xmlEventNameToPrefab.set(k16,v16);
		v16;
		var k17 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DELETE);
		var v17 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DELETE;
		this._xmlEventNameToPrefab.set(k17,v17);
		v17;
		var k18 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DOWN);
		var v18 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DOWN;
		this._xmlEventNameToPrefab.set(k18,v18);
		v18;
		var k19 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_END);
		var v19 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_END;
		this._xmlEventNameToPrefab.set(k19,v19);
		v19;
		var k20 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ENTER);
		var v20 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ENTER;
		this._xmlEventNameToPrefab.set(k20,v20);
		v20;
		var k21 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ESCAPE);
		var v21 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ESCAPE;
		this._xmlEventNameToPrefab.set(k21,v21);
		v21;
		var k22 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F1);
		var v22 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F1;
		this._xmlEventNameToPrefab.set(k22,v22);
		v22;
		var k23 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F10);
		var v23 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F10;
		this._xmlEventNameToPrefab.set(k23,v23);
		v23;
		var k24 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F11);
		var v24 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F11;
		this._xmlEventNameToPrefab.set(k24,v24);
		v24;
		var k25 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F12);
		var v25 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F12;
		this._xmlEventNameToPrefab.set(k25,v25);
		v25;
		var k26 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F13);
		var v26 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F13;
		this._xmlEventNameToPrefab.set(k26,v26);
		v26;
		var k27 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F14);
		var v27 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F14;
		this._xmlEventNameToPrefab.set(k27,v27);
		v27;
		var k28 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F15);
		var v28 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F15;
		this._xmlEventNameToPrefab.set(k28,v28);
		v28;
		var k29 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F2);
		var v29 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F2;
		this._xmlEventNameToPrefab.set(k29,v29);
		v29;
		var k30 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F3);
		var v30 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F3;
		this._xmlEventNameToPrefab.set(k30,v30);
		v30;
		var k31 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F4);
		var v31 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F4;
		this._xmlEventNameToPrefab.set(k31,v31);
		v31;
		var k32 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F5);
		var v32 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F5;
		this._xmlEventNameToPrefab.set(k32,v32);
		v32;
		var k33 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F6);
		var v33 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F6;
		this._xmlEventNameToPrefab.set(k33,v33);
		v33;
		var k34 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F7);
		var v34 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F7;
		this._xmlEventNameToPrefab.set(k34,v34);
		v34;
		var k35 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F8);
		var v35 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F8;
		this._xmlEventNameToPrefab.set(k35,v35);
		v35;
		var k36 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F9);
		var v36 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F9;
		this._xmlEventNameToPrefab.set(k36,v36);
		v36;
		var k37 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_HOME);
		var v37 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_HOME;
		this._xmlEventNameToPrefab.set(k37,v37);
		v37;
		var k38 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_INSERT);
		var v38 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_INSERT;
		this._xmlEventNameToPrefab.set(k38,v38);
		v38;
		var k39 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFT);
		var v39 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFT;
		this._xmlEventNameToPrefab.set(k39,v39);
		v39;
		var k40 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_0);
		var v40 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_0;
		this._xmlEventNameToPrefab.set(k40,v40);
		v40;
		var k41 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_1);
		var v41 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_1;
		this._xmlEventNameToPrefab.set(k41,v41);
		v41;
		var k42 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_2);
		var v42 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_2;
		this._xmlEventNameToPrefab.set(k42,v42);
		v42;
		var k43 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_3);
		var v43 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_3;
		this._xmlEventNameToPrefab.set(k43,v43);
		v43;
		var k44 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_4);
		var v44 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_4;
		this._xmlEventNameToPrefab.set(k44,v44);
		v44;
		var k45 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_5);
		var v45 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_5;
		this._xmlEventNameToPrefab.set(k45,v45);
		v45;
		var k46 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_6);
		var v46 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_6;
		this._xmlEventNameToPrefab.set(k46,v46);
		v46;
		var k47 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_7);
		var v47 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_7;
		this._xmlEventNameToPrefab.set(k47,v47);
		v47;
		var k48 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_8);
		var v48 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_8;
		this._xmlEventNameToPrefab.set(k48,v48);
		v48;
		var k49 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_9);
		var v49 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_9;
		this._xmlEventNameToPrefab.set(k49,v49);
		v49;
		var k50 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ADD);
		var v50 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ADD;
		this._xmlEventNameToPrefab.set(k50,v50);
		v50;
		var k51 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DECIMAL);
		var v51 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DECIMAL;
		this._xmlEventNameToPrefab.set(k51,v51);
		v51;
		var k52 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DIVIDE);
		var v52 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DIVIDE;
		this._xmlEventNameToPrefab.set(k52,v52);
		v52;
		var k53 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ENTER);
		var v53 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ENTER;
		this._xmlEventNameToPrefab.set(k53,v53);
		v53;
		var k54 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_MULTIPLY);
		var v54 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_MULTIPLY;
		this._xmlEventNameToPrefab.set(k54,v54);
		v54;
		var k55 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_SUBTRACT);
		var v55 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_SUBTRACT;
		this._xmlEventNameToPrefab.set(k55,v55);
		v55;
		var k56 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_DOWN);
		var v56 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_DOWN;
		this._xmlEventNameToPrefab.set(k56,v56);
		v56;
		var k57 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_UP);
		var v57 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_UP;
		this._xmlEventNameToPrefab.set(k57,v57);
		v57;
		var k58 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHT);
		var v58 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHT;
		this._xmlEventNameToPrefab.set(k58,v58);
		v58;
		var k59 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SHIFT);
		var v59 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SHIFT;
		this._xmlEventNameToPrefab.set(k59,v59);
		v59;
		var k60 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SPACE);
		var v60 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SPACE;
		this._xmlEventNameToPrefab.set(k60,v60);
		v60;
		var k61 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_TAB);
		var v61 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_TAB;
		this._xmlEventNameToPrefab.set(k61,v61);
		v61;
		var k62 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UP);
		var v62 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UP;
		this._xmlEventNameToPrefab.set(k62,v62);
		v62;
		var k63 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_A);
		var v63 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_A;
		this._xmlEventNameToPrefab.set(k63,v63);
		v63;
		var k64 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_B);
		var v64 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_B;
		this._xmlEventNameToPrefab.set(k64,v64);
		v64;
		var k65 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_C);
		var v65 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_C;
		this._xmlEventNameToPrefab.set(k65,v65);
		v65;
		var k66 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_D);
		var v66 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_D;
		this._xmlEventNameToPrefab.set(k66,v66);
		v66;
		var k67 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_E);
		var v67 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_E;
		this._xmlEventNameToPrefab.set(k67,v67);
		v67;
		var k68 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F);
		var v68 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F;
		this._xmlEventNameToPrefab.set(k68,v68);
		v68;
		var k69 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_G);
		var v69 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_G;
		this._xmlEventNameToPrefab.set(k69,v69);
		v69;
		var k70 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_H);
		var v70 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_H;
		this._xmlEventNameToPrefab.set(k70,v70);
		v70;
		var k71 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_I);
		var v71 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_I;
		this._xmlEventNameToPrefab.set(k71,v71);
		v71;
		var k72 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_J);
		var v72 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_J;
		this._xmlEventNameToPrefab.set(k72,v72);
		v72;
		var k73 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_K);
		var v73 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_K;
		this._xmlEventNameToPrefab.set(k73,v73);
		v73;
		var k74 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_L);
		var v74 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_L;
		this._xmlEventNameToPrefab.set(k74,v74);
		v74;
		var k75 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_M);
		var v75 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_M;
		this._xmlEventNameToPrefab.set(k75,v75);
		v75;
		var k76 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_N);
		var v76 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_N;
		this._xmlEventNameToPrefab.set(k76,v76);
		v76;
		var k77 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_O);
		var v77 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_O;
		this._xmlEventNameToPrefab.set(k77,v77);
		v77;
		var k78 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_P);
		var v78 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_P;
		this._xmlEventNameToPrefab.set(k78,v78);
		v78;
		var k79 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Q);
		var v79 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Q;
		this._xmlEventNameToPrefab.set(k79,v79);
		v79;
		var k80 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_R);
		var v80 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_R;
		this._xmlEventNameToPrefab.set(k80,v80);
		v80;
		var k81 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_S);
		var v81 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_S;
		this._xmlEventNameToPrefab.set(k81,v81);
		v81;
		var k82 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_T);
		var v82 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_T;
		this._xmlEventNameToPrefab.set(k82,v82);
		v82;
		var k83 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_U);
		var v83 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_U;
		this._xmlEventNameToPrefab.set(k83,v83);
		v83;
		var k84 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_V);
		var v84 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_V;
		this._xmlEventNameToPrefab.set(k84,v84);
		v84;
		var k85 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_W);
		var v85 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_W;
		this._xmlEventNameToPrefab.set(k85,v85);
		v85;
		var k86 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_X);
		var v86 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_X;
		this._xmlEventNameToPrefab.set(k86,v86);
		v86;
		var k87 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Y);
		var v87 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Y;
		this._xmlEventNameToPrefab.set(k87,v87);
		v87;
		var k88 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Z);
		var v88 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Z;
		this._xmlEventNameToPrefab.set(k88,v88);
		v88;
		var k89 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_0);
		var v89 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_0;
		this._xmlEventNameToPrefab.set(k89,v89);
		v89;
		var k90 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_1);
		var v90 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_1;
		this._xmlEventNameToPrefab.set(k90,v90);
		v90;
		var k91 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_2);
		var v91 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_2;
		this._xmlEventNameToPrefab.set(k91,v91);
		v91;
		var k92 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_3);
		var v92 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_3;
		this._xmlEventNameToPrefab.set(k92,v92);
		v92;
		var k93 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_4);
		var v93 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_4;
		this._xmlEventNameToPrefab.set(k93,v93);
		v93;
		var k94 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_5);
		var v94 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_5;
		this._xmlEventNameToPrefab.set(k94,v94);
		v94;
		var k95 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_6);
		var v95 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_6;
		this._xmlEventNameToPrefab.set(k95,v95);
		v95;
		var k96 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_7);
		var v96 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_7;
		this._xmlEventNameToPrefab.set(k96,v96);
		v96;
		var k97 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_8);
		var v97 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_8;
		this._xmlEventNameToPrefab.set(k97,v97);
		v97;
		var k98 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_9);
		var v98 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_9;
		this._xmlEventNameToPrefab.set(k98,v98);
		v98;
		var k99 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_EQUALS);
		var v99 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_EQUALS;
		this._xmlEventNameToPrefab.set(k99,v99);
		v99;
		var k100 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SLASH);
		var v100 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SLASH;
		this._xmlEventNameToPrefab.set(k100,v100);
		v100;
		var k101 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSLASH);
		var v101 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSLASH;
		this._xmlEventNameToPrefab.set(k101,v101);
		v101;
		var k102 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFTBRACKET);
		var v102 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFTBRACKET;
		this._xmlEventNameToPrefab.set(k102,v102);
		v102;
		var k103 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHTBRACKET);
		var v103 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHTBRACKET;
		this._xmlEventNameToPrefab.set(k103,v103);
		v103;
		var k104 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKQUOTE);
		var v104 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKQUOTE;
		this._xmlEventNameToPrefab.set(k104,v104);
		v104;
		var k105 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMA);
		var v105 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMA;
		this._xmlEventNameToPrefab.set(k105,v105);
		v105;
		var k106 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMAND);
		var v106 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMAND;
		this._xmlEventNameToPrefab.set(k106,v106);
		v106;
		var k107 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_MINUS);
		var v107 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_MINUS;
		this._xmlEventNameToPrefab.set(k107,v107);
		v107;
		var k108 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PERIOD);
		var v108 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PERIOD;
		this._xmlEventNameToPrefab.set(k108,v108);
		v108;
		var k109 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_QUOTE);
		var v109 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_QUOTE;
		this._xmlEventNameToPrefab.set(k109,v109);
		v109;
		var k110 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SEMICOLON);
		var v110 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SEMICOLON;
		this._xmlEventNameToPrefab.set(k110,v110);
		v110;
		var k111 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDMENU);
		var v111 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDMENU;
		this._xmlEventNameToPrefab.set(k111,v111);
		v111;
		var k112 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDSEARCH);
		var v112 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDSEARCH;
		this._xmlEventNameToPrefab.set(k112,v112);
		v112;
		var k113 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UNKNOWN);
		var v113 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UNKNOWN;
		this._xmlEventNameToPrefab.set(k113,v113);
		v113;
		var k114 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ALT);
		var v114 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ALT;
		this._xmlEventNameToPrefab.set(k114,v114);
		v114;
		var k115 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSPACE);
		var v115 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSPACE;
		this._xmlEventNameToPrefab.set(k115,v115);
		v115;
		var k116 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CAPS_LOCK);
		var v116 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CAPS_LOCK;
		this._xmlEventNameToPrefab.set(k116,v116);
		v116;
		var k117 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CONTROL);
		var v117 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CONTROL;
		this._xmlEventNameToPrefab.set(k117,v117);
		v117;
		var k118 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DELETE);
		var v118 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DELETE;
		this._xmlEventNameToPrefab.set(k118,v118);
		v118;
		var k119 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DOWN);
		var v119 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DOWN;
		this._xmlEventNameToPrefab.set(k119,v119);
		v119;
		var k120 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_END);
		var v120 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_END;
		this._xmlEventNameToPrefab.set(k120,v120);
		v120;
		var k121 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ENTER);
		var v121 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ENTER;
		this._xmlEventNameToPrefab.set(k121,v121);
		v121;
		var k122 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ESCAPE);
		var v122 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ESCAPE;
		this._xmlEventNameToPrefab.set(k122,v122);
		v122;
		var k123 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F1);
		var v123 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F1;
		this._xmlEventNameToPrefab.set(k123,v123);
		v123;
		var k124 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F10);
		var v124 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F10;
		this._xmlEventNameToPrefab.set(k124,v124);
		v124;
		var k125 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F11);
		var v125 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F11;
		this._xmlEventNameToPrefab.set(k125,v125);
		v125;
		var k126 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F12);
		var v126 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F12;
		this._xmlEventNameToPrefab.set(k126,v126);
		v126;
		var k127 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F13);
		var v127 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F13;
		this._xmlEventNameToPrefab.set(k127,v127);
		v127;
		var k128 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F14);
		var v128 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F14;
		this._xmlEventNameToPrefab.set(k128,v128);
		v128;
		var k129 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F15);
		var v129 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F15;
		this._xmlEventNameToPrefab.set(k129,v129);
		v129;
		var k130 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F2);
		var v130 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F2;
		this._xmlEventNameToPrefab.set(k130,v130);
		v130;
		var k131 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F3);
		var v131 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F3;
		this._xmlEventNameToPrefab.set(k131,v131);
		v131;
		var k132 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F4);
		var v132 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F4;
		this._xmlEventNameToPrefab.set(k132,v132);
		v132;
		var k133 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F5);
		var v133 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F5;
		this._xmlEventNameToPrefab.set(k133,v133);
		v133;
		var k134 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F6);
		var v134 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F6;
		this._xmlEventNameToPrefab.set(k134,v134);
		v134;
		var k135 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F7);
		var v135 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F7;
		this._xmlEventNameToPrefab.set(k135,v135);
		v135;
		var k136 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F8);
		var v136 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F8;
		this._xmlEventNameToPrefab.set(k136,v136);
		v136;
		var k137 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F9);
		var v137 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F9;
		this._xmlEventNameToPrefab.set(k137,v137);
		v137;
		var k138 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_HOME);
		var v138 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_HOME;
		this._xmlEventNameToPrefab.set(k138,v138);
		v138;
		var k139 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_INSERT);
		var v139 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_INSERT;
		this._xmlEventNameToPrefab.set(k139,v139);
		v139;
		var k140 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFT);
		var v140 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFT;
		this._xmlEventNameToPrefab.set(k140,v140);
		v140;
		var k141 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_0);
		var v141 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_0;
		this._xmlEventNameToPrefab.set(k141,v141);
		v141;
		var k142 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_1);
		var v142 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_1;
		this._xmlEventNameToPrefab.set(k142,v142);
		v142;
		var k143 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_2);
		var v143 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_2;
		this._xmlEventNameToPrefab.set(k143,v143);
		v143;
		var k144 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_3);
		var v144 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_3;
		this._xmlEventNameToPrefab.set(k144,v144);
		v144;
		var k145 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_4);
		var v145 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_4;
		this._xmlEventNameToPrefab.set(k145,v145);
		v145;
		var k146 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_5);
		var v146 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_5;
		this._xmlEventNameToPrefab.set(k146,v146);
		v146;
		var k147 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_6);
		var v147 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_6;
		this._xmlEventNameToPrefab.set(k147,v147);
		v147;
		var k148 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_7);
		var v148 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_7;
		this._xmlEventNameToPrefab.set(k148,v148);
		v148;
		var k149 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_8);
		var v149 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_8;
		this._xmlEventNameToPrefab.set(k149,v149);
		v149;
		var k150 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_9);
		var v150 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_9;
		this._xmlEventNameToPrefab.set(k150,v150);
		v150;
		var k151 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ADD);
		var v151 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ADD;
		this._xmlEventNameToPrefab.set(k151,v151);
		v151;
		var k152 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DECIMAL);
		var v152 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DECIMAL;
		this._xmlEventNameToPrefab.set(k152,v152);
		v152;
		var k153 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DIVIDE);
		var v153 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DIVIDE;
		this._xmlEventNameToPrefab.set(k153,v153);
		v153;
		var k154 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ENTER);
		var v154 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ENTER;
		this._xmlEventNameToPrefab.set(k154,v154);
		v154;
		var k155 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_MULTIPLY);
		var v155 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_MULTIPLY;
		this._xmlEventNameToPrefab.set(k155,v155);
		v155;
		var k156 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_SUBTRACT);
		var v156 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_SUBTRACT;
		this._xmlEventNameToPrefab.set(k156,v156);
		v156;
		var k157 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_DOWN);
		var v157 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_DOWN;
		this._xmlEventNameToPrefab.set(k157,v157);
		v157;
		var k158 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_UP);
		var v158 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_UP;
		this._xmlEventNameToPrefab.set(k158,v158);
		v158;
		var k159 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHT);
		var v159 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHT;
		this._xmlEventNameToPrefab.set(k159,v159);
		v159;
		var k160 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SHIFT);
		var v160 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SHIFT;
		this._xmlEventNameToPrefab.set(k160,v160);
		v160;
		var k161 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SPACE);
		var v161 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SPACE;
		this._xmlEventNameToPrefab.set(k161,v161);
		v161;
		var k162 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_TAB);
		var v162 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_TAB;
		this._xmlEventNameToPrefab.set(k162,v162);
		v162;
		var k163 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UP);
		var v163 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UP;
		this._xmlEventNameToPrefab.set(k163,v163);
		v163;
		var k164 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_A);
		var v164 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_A;
		this._xmlEventNameToPrefab.set(k164,v164);
		v164;
		var k165 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_B);
		var v165 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_B;
		this._xmlEventNameToPrefab.set(k165,v165);
		v165;
		var k166 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_C);
		var v166 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_C;
		this._xmlEventNameToPrefab.set(k166,v166);
		v166;
		var k167 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_D);
		var v167 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_D;
		this._xmlEventNameToPrefab.set(k167,v167);
		v167;
		var k168 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_E);
		var v168 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_E;
		this._xmlEventNameToPrefab.set(k168,v168);
		v168;
		var k169 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F);
		var v169 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F;
		this._xmlEventNameToPrefab.set(k169,v169);
		v169;
		var k170 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_G);
		var v170 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_G;
		this._xmlEventNameToPrefab.set(k170,v170);
		v170;
		var k171 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_H);
		var v171 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_H;
		this._xmlEventNameToPrefab.set(k171,v171);
		v171;
		var k172 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_I);
		var v172 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_I;
		this._xmlEventNameToPrefab.set(k172,v172);
		v172;
		var k173 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_J);
		var v173 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_J;
		this._xmlEventNameToPrefab.set(k173,v173);
		v173;
		var k174 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_K);
		var v174 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_K;
		this._xmlEventNameToPrefab.set(k174,v174);
		v174;
		var k175 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_L);
		var v175 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_L;
		this._xmlEventNameToPrefab.set(k175,v175);
		v175;
		var k176 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_M);
		var v176 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_M;
		this._xmlEventNameToPrefab.set(k176,v176);
		v176;
		var k177 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_N);
		var v177 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_N;
		this._xmlEventNameToPrefab.set(k177,v177);
		v177;
		var k178 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_O);
		var v178 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_O;
		this._xmlEventNameToPrefab.set(k178,v178);
		v178;
		var k179 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_P);
		var v179 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_P;
		this._xmlEventNameToPrefab.set(k179,v179);
		v179;
		var k180 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Q);
		var v180 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Q;
		this._xmlEventNameToPrefab.set(k180,v180);
		v180;
		var k181 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_R);
		var v181 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_R;
		this._xmlEventNameToPrefab.set(k181,v181);
		v181;
		var k182 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_S);
		var v182 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_S;
		this._xmlEventNameToPrefab.set(k182,v182);
		v182;
		var k183 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_T);
		var v183 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_T;
		this._xmlEventNameToPrefab.set(k183,v183);
		v183;
		var k184 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_U);
		var v184 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_U;
		this._xmlEventNameToPrefab.set(k184,v184);
		v184;
		var k185 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_V);
		var v185 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_V;
		this._xmlEventNameToPrefab.set(k185,v185);
		v185;
		var k186 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_W);
		var v186 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_W;
		this._xmlEventNameToPrefab.set(k186,v186);
		v186;
		var k187 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_X);
		var v187 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_X;
		this._xmlEventNameToPrefab.set(k187,v187);
		v187;
		var k188 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Y);
		var v188 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Y;
		this._xmlEventNameToPrefab.set(k188,v188);
		v188;
		var k189 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Z);
		var v189 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Z;
		this._xmlEventNameToPrefab.set(k189,v189);
		v189;
		var k190 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_0);
		var v190 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_0;
		this._xmlEventNameToPrefab.set(k190,v190);
		v190;
		var k191 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_1);
		var v191 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_1;
		this._xmlEventNameToPrefab.set(k191,v191);
		v191;
		var k192 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_2);
		var v192 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_2;
		this._xmlEventNameToPrefab.set(k192,v192);
		v192;
		var k193 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_3);
		var v193 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_3;
		this._xmlEventNameToPrefab.set(k193,v193);
		v193;
		var k194 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_4);
		var v194 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_4;
		this._xmlEventNameToPrefab.set(k194,v194);
		v194;
		var k195 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_5);
		var v195 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_5;
		this._xmlEventNameToPrefab.set(k195,v195);
		v195;
		var k196 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_6);
		var v196 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_6;
		this._xmlEventNameToPrefab.set(k196,v196);
		v196;
		var k197 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_7);
		var v197 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_7;
		this._xmlEventNameToPrefab.set(k197,v197);
		v197;
		var k198 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_8);
		var v198 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_8;
		this._xmlEventNameToPrefab.set(k198,v198);
		v198;
		var k199 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_9);
		var v199 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_9;
		this._xmlEventNameToPrefab.set(k199,v199);
		v199;
		var k200 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_EQUALS);
		var v200 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_EQUALS;
		this._xmlEventNameToPrefab.set(k200,v200);
		v200;
		var k201 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SLASH);
		var v201 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SLASH;
		this._xmlEventNameToPrefab.set(k201,v201);
		v201;
		var k202 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSLASH);
		var v202 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSLASH;
		this._xmlEventNameToPrefab.set(k202,v202);
		v202;
		var k203 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFTBRACKET);
		var v203 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFTBRACKET;
		this._xmlEventNameToPrefab.set(k203,v203);
		v203;
		var k204 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHTBRACKET);
		var v204 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHTBRACKET;
		this._xmlEventNameToPrefab.set(k204,v204);
		v204;
		var k205 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKQUOTE);
		var v205 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKQUOTE;
		this._xmlEventNameToPrefab.set(k205,v205);
		v205;
		var k206 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMA);
		var v206 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMA;
		this._xmlEventNameToPrefab.set(k206,v206);
		v206;
		var k207 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMAND);
		var v207 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMAND;
		this._xmlEventNameToPrefab.set(k207,v207);
		v207;
		var k208 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_MINUS);
		var v208 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_MINUS;
		this._xmlEventNameToPrefab.set(k208,v208);
		v208;
		var k209 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PERIOD);
		var v209 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PERIOD;
		this._xmlEventNameToPrefab.set(k209,v209);
		v209;
		var k210 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_QUOTE);
		var v210 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_QUOTE;
		this._xmlEventNameToPrefab.set(k210,v210);
		v210;
		var k211 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SEMICOLON);
		var v211 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SEMICOLON;
		this._xmlEventNameToPrefab.set(k211,v211);
		v211;
		var k212 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDMENU);
		var v212 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDMENU;
		this._xmlEventNameToPrefab.set(k212,v212);
		v212;
		var k213 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDSEARCH);
		var v213 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDSEARCH;
		this._xmlEventNameToPrefab.set(k213,v213);
		v213;
		var k214 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UNKNOWN);
		var v214 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UNKNOWN;
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT_CLICK = ["MOUSE_LEFT_CLICK",5];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_RIGHT_CLICK = ["MOUSE_RIGHT_CLICK",6];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT_CLICKED = ["MOUSE_LEFT_CLICKED",7];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_RIGHT_CLICKED = ["MOUSE_RIGHT_CLICKED",8];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_ENTERED = ["MOUSE_ENTERED",9];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT = ["MOUSE_LEFT",10];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED = ["KEY_PRESSED",11];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED = ["KEY_RELEASED",12];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ALT = ["KEY_PRESSED_ALT",13];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSPACE = ["KEY_PRESSED_BACKSPACE",14];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CAPS_LOCK = ["KEY_PRESSED_CAPS_LOCK",15];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CONTROL = ["KEY_PRESSED_CONTROL",16];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DELETE = ["KEY_PRESSED_DELETE",17];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DOWN = ["KEY_PRESSED_DOWN",18];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_END = ["KEY_PRESSED_END",19];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ENTER = ["KEY_PRESSED_ENTER",20];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ESCAPE = ["KEY_PRESSED_ESCAPE",21];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F1 = ["KEY_PRESSED_F1",22];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F10 = ["KEY_PRESSED_F10",23];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F11 = ["KEY_PRESSED_F11",24];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F12 = ["KEY_PRESSED_F12",25];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F13 = ["KEY_PRESSED_F13",26];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F14 = ["KEY_PRESSED_F14",27];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F15 = ["KEY_PRESSED_F15",28];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F2 = ["KEY_PRESSED_F2",29];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F3 = ["KEY_PRESSED_F3",30];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F4 = ["KEY_PRESSED_F4",31];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F5 = ["KEY_PRESSED_F5",32];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F6 = ["KEY_PRESSED_F6",33];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F7 = ["KEY_PRESSED_F7",34];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F8 = ["KEY_PRESSED_F8",35];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F9 = ["KEY_PRESSED_F9",36];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_HOME = ["KEY_PRESSED_HOME",37];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_INSERT = ["KEY_PRESSED_INSERT",38];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFT = ["KEY_PRESSED_LEFT",39];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_0 = ["KEY_PRESSED_NUMPAD_0",40];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_1 = ["KEY_PRESSED_NUMPAD_1",41];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_2 = ["KEY_PRESSED_NUMPAD_2",42];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_3 = ["KEY_PRESSED_NUMPAD_3",43];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_4 = ["KEY_PRESSED_NUMPAD_4",44];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_5 = ["KEY_PRESSED_NUMPAD_5",45];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_6 = ["KEY_PRESSED_NUMPAD_6",46];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_7 = ["KEY_PRESSED_NUMPAD_7",47];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_8 = ["KEY_PRESSED_NUMPAD_8",48];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_9 = ["KEY_PRESSED_NUMPAD_9",49];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ADD = ["KEY_PRESSED_NUMPAD_ADD",50];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DECIMAL = ["KEY_PRESSED_NUMPAD_DECIMAL",51];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DIVIDE = ["KEY_PRESSED_NUMPAD_DIVIDE",52];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ENTER = ["KEY_PRESSED_NUMPAD_ENTER",53];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_MULTIPLY = ["KEY_PRESSED_NUMPAD_MULTIPLY",54];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_SUBTRACT = ["KEY_PRESSED_NUMPAD_SUBTRACT",55];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_DOWN = ["KEY_PRESSED_PAGE_DOWN",56];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_UP = ["KEY_PRESSED_PAGE_UP",57];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHT = ["KEY_PRESSED_RIGHT",58];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SHIFT = ["KEY_PRESSED_SHIFT",59];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SPACE = ["KEY_PRESSED_SPACE",60];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_TAB = ["KEY_PRESSED_TAB",61];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UP = ["KEY_PRESSED_UP",62];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_A = ["KEY_PRESSED_A",63];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_B = ["KEY_PRESSED_B",64];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_C = ["KEY_PRESSED_C",65];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_D = ["KEY_PRESSED_D",66];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_E = ["KEY_PRESSED_E",67];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F = ["KEY_PRESSED_F",68];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_G = ["KEY_PRESSED_G",69];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_H = ["KEY_PRESSED_H",70];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_I = ["KEY_PRESSED_I",71];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_J = ["KEY_PRESSED_J",72];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_K = ["KEY_PRESSED_K",73];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_L = ["KEY_PRESSED_L",74];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_M = ["KEY_PRESSED_M",75];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_N = ["KEY_PRESSED_N",76];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_O = ["KEY_PRESSED_O",77];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_P = ["KEY_PRESSED_P",78];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Q = ["KEY_PRESSED_Q",79];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_R = ["KEY_PRESSED_R",80];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_S = ["KEY_PRESSED_S",81];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_T = ["KEY_PRESSED_T",82];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_U = ["KEY_PRESSED_U",83];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_V = ["KEY_PRESSED_V",84];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_W = ["KEY_PRESSED_W",85];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_X = ["KEY_PRESSED_X",86];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Y = ["KEY_PRESSED_Y",87];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Z = ["KEY_PRESSED_Z",88];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_0 = ["KEY_PRESSED_NUMBER_0",89];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_1 = ["KEY_PRESSED_NUMBER_1",90];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_2 = ["KEY_PRESSED_NUMBER_2",91];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_3 = ["KEY_PRESSED_NUMBER_3",92];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_4 = ["KEY_PRESSED_NUMBER_4",93];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_5 = ["KEY_PRESSED_NUMBER_5",94];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_6 = ["KEY_PRESSED_NUMBER_6",95];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_7 = ["KEY_PRESSED_NUMBER_7",96];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_8 = ["KEY_PRESSED_NUMBER_8",97];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_9 = ["KEY_PRESSED_NUMBER_9",98];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_EQUALS = ["KEY_PRESSED_EQUALS",99];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SLASH = ["KEY_PRESSED_SLASH",100];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSLASH = ["KEY_PRESSED_BACKSLASH",101];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFTBRACKET = ["KEY_PRESSED_LEFTBRACKET",102];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHTBRACKET = ["KEY_PRESSED_RIGHTBRACKET",103];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKQUOTE = ["KEY_PRESSED_BACKQUOTE",104];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMA = ["KEY_PRESSED_COMMA",105];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMAND = ["KEY_PRESSED_COMMAND",106];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_MINUS = ["KEY_PRESSED_MINUS",107];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PERIOD = ["KEY_PRESSED_PERIOD",108];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_QUOTE = ["KEY_PRESSED_QUOTE",109];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SEMICOLON = ["KEY_PRESSED_SEMICOLON",110];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDMENU = ["KEY_PRESSED_ANDROIDMENU",111];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDSEARCH = ["KEY_PRESSED_ANDROIDSEARCH",112];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UNKNOWN = ["KEY_PRESSED_UNKNOWN",113];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ALT = ["KEY_RELEASED_ALT",114];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSPACE = ["KEY_RELEASED_BACKSPACE",115];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CAPS_LOCK = ["KEY_RELEASED_CAPS_LOCK",116];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CONTROL = ["KEY_RELEASED_CONTROL",117];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DELETE = ["KEY_RELEASED_DELETE",118];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DOWN = ["KEY_RELEASED_DOWN",119];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_END = ["KEY_RELEASED_END",120];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ENTER = ["KEY_RELEASED_ENTER",121];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ESCAPE = ["KEY_RELEASED_ESCAPE",122];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F1 = ["KEY_RELEASED_F1",123];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F10 = ["KEY_RELEASED_F10",124];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F11 = ["KEY_RELEASED_F11",125];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F12 = ["KEY_RELEASED_F12",126];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F13 = ["KEY_RELEASED_F13",127];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F14 = ["KEY_RELEASED_F14",128];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F15 = ["KEY_RELEASED_F15",129];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F2 = ["KEY_RELEASED_F2",130];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F3 = ["KEY_RELEASED_F3",131];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F4 = ["KEY_RELEASED_F4",132];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F5 = ["KEY_RELEASED_F5",133];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F6 = ["KEY_RELEASED_F6",134];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F7 = ["KEY_RELEASED_F7",135];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F8 = ["KEY_RELEASED_F8",136];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F9 = ["KEY_RELEASED_F9",137];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_HOME = ["KEY_RELEASED_HOME",138];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_INSERT = ["KEY_RELEASED_INSERT",139];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFT = ["KEY_RELEASED_LEFT",140];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_0 = ["KEY_RELEASED_NUMPAD_0",141];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_1 = ["KEY_RELEASED_NUMPAD_1",142];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_2 = ["KEY_RELEASED_NUMPAD_2",143];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_3 = ["KEY_RELEASED_NUMPAD_3",144];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_4 = ["KEY_RELEASED_NUMPAD_4",145];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_5 = ["KEY_RELEASED_NUMPAD_5",146];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_6 = ["KEY_RELEASED_NUMPAD_6",147];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_7 = ["KEY_RELEASED_NUMPAD_7",148];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_8 = ["KEY_RELEASED_NUMPAD_8",149];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_9 = ["KEY_RELEASED_NUMPAD_9",150];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ADD = ["KEY_RELEASED_NUMPAD_ADD",151];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DECIMAL = ["KEY_RELEASED_NUMPAD_DECIMAL",152];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DIVIDE = ["KEY_RELEASED_NUMPAD_DIVIDE",153];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ENTER = ["KEY_RELEASED_NUMPAD_ENTER",154];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_MULTIPLY = ["KEY_RELEASED_NUMPAD_MULTIPLY",155];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_SUBTRACT = ["KEY_RELEASED_NUMPAD_SUBTRACT",156];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_DOWN = ["KEY_RELEASED_PAGE_DOWN",157];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_UP = ["KEY_RELEASED_PAGE_UP",158];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHT = ["KEY_RELEASED_RIGHT",159];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SHIFT = ["KEY_RELEASED_SHIFT",160];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SPACE = ["KEY_RELEASED_SPACE",161];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_TAB = ["KEY_RELEASED_TAB",162];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UP = ["KEY_RELEASED_UP",163];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_A = ["KEY_RELEASED_A",164];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_B = ["KEY_RELEASED_B",165];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_C = ["KEY_RELEASED_C",166];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_D = ["KEY_RELEASED_D",167];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_E = ["KEY_RELEASED_E",168];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F = ["KEY_RELEASED_F",169];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_G = ["KEY_RELEASED_G",170];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_H = ["KEY_RELEASED_H",171];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_I = ["KEY_RELEASED_I",172];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_J = ["KEY_RELEASED_J",173];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_K = ["KEY_RELEASED_K",174];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_L = ["KEY_RELEASED_L",175];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_M = ["KEY_RELEASED_M",176];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_N = ["KEY_RELEASED_N",177];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_O = ["KEY_RELEASED_O",178];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_P = ["KEY_RELEASED_P",179];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Q = ["KEY_RELEASED_Q",180];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_R = ["KEY_RELEASED_R",181];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_S = ["KEY_RELEASED_S",182];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_T = ["KEY_RELEASED_T",183];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_U = ["KEY_RELEASED_U",184];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_V = ["KEY_RELEASED_V",185];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_W = ["KEY_RELEASED_W",186];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_X = ["KEY_RELEASED_X",187];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Y = ["KEY_RELEASED_Y",188];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Z = ["KEY_RELEASED_Z",189];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_0 = ["KEY_RELEASED_NUMBER_0",190];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_1 = ["KEY_RELEASED_NUMBER_1",191];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_2 = ["KEY_RELEASED_NUMBER_2",192];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_3 = ["KEY_RELEASED_NUMBER_3",193];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_4 = ["KEY_RELEASED_NUMBER_4",194];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_5 = ["KEY_RELEASED_NUMBER_5",195];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_6 = ["KEY_RELEASED_NUMBER_6",196];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_7 = ["KEY_RELEASED_NUMBER_7",197];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_8 = ["KEY_RELEASED_NUMBER_8",198];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_9 = ["KEY_RELEASED_NUMBER_9",199];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_EQUALS = ["KEY_RELEASED_EQUALS",200];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SLASH = ["KEY_RELEASED_SLASH",201];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSLASH = ["KEY_RELEASED_BACKSLASH",202];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFTBRACKET = ["KEY_RELEASED_LEFTBRACKET",203];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHTBRACKET = ["KEY_RELEASED_RIGHTBRACKET",204];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKQUOTE = ["KEY_RELEASED_BACKQUOTE",205];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMA = ["KEY_RELEASED_COMMA",206];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMAND = ["KEY_RELEASED_COMMAND",207];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_MINUS = ["KEY_RELEASED_MINUS",208];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PERIOD = ["KEY_RELEASED_PERIOD",209];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_QUOTE = ["KEY_RELEASED_QUOTE",210];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SEMICOLON = ["KEY_RELEASED_SEMICOLON",211];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDMENU = ["KEY_RELEASED_ANDROIDMENU",212];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDSEARCH = ["KEY_RELEASED_ANDROIDSEARCH",213];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UNKNOWN = ["KEY_RELEASED_UNKNOWN",214];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.MOUSE_LEFT_CLICK = ["MOUSE_LEFT_CLICK",5];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.MOUSE_RIGHT_CLICK = ["MOUSE_RIGHT_CLICK",6];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.MOUSE_ENTERED = ["MOUSE_ENTERED",7];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.MOUSE_LEFT = ["MOUSE_LEFT",8];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED = ["KEY_PRESSED",9];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED = ["KEY_RELEASED",10];
