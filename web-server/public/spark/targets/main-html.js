...
flambe_platform_html_HtmlPlatform.prototype = {
	...
	,createRenderer: function(canvas) {
		var gl = tools_spark_framework_platform_html_away3d_Subgraphics.initAway3DStage3DgetContext3D();
...
tools_spark_framework_flambe2_$5D_FlambeEntity2_$5D.prototype = $extend(tools_spark_framework_space2_$5D_core_AEntity2_$5D.prototype,{
	_initFlambeEntity2_5D: function() {
		...
		v5;
		var v6 = $bind(this,this._update2DMeshImageForm);
		this._updateStateFunctions.set("2DMeshImageForm",v6);
		v6;
		var v7 = $bind(this,this._update2DMeshSpriterForm);
		this._updateStateFunctions.set("2DMeshSpriterForm",v7);
		v7;
		var v8 = $bind(this,this._update2DMeshFillRectForm);
		this._updateStateFunctions.set("2DMeshFillRectForm",v8);
		v8;
		var v9 = $bind(this,this._update2DMeshSpriteForm);
		this._updateStateFunctions.set("2DMeshSpriteForm",v9);
		v9;
		var v10 = $bind(this,this._update2DMeshSpriterAnimForm);
		this._updateStateFunctions.set("2DMeshSpriterAnimForm",v10);
		v10;
	}
	,createInstance: function(p_view2_5D) {
	...
	,_onPointerIn: function(p_pointerEvent) {
		tools_spark_framework_Console.error("Event Listener for Pointer In for: " + Std.string(this.gameEntity.getState("name")));
...
tools_spark_framework_platform_html_Graphics.init = function() {
	tools_spark_framework_platform_html_away3d_Subgraphics.init();
};
tools_spark_framework_platform_html_Graphics.createDisplayRenderers = function() {
	tools_spark_framework_platform_html_away3d_Subgraphics.createDisplayRenderers();
...
var tools_spark_framework_platform_html_away3d_Subgraphics = function() { };
$hxClasses["tools.spark.framework.platform.html.away3d.Subgraphics"] = tools_spark_framework_platform_html_away3d_Subgraphics;
tools_spark_framework_platform_html_away3d_Subgraphics.__name__ = true;
tools_spark_framework_platform_html_away3d_Subgraphics.createDisplayRenderers = function() {
	...
	v;
	var v1 = new tools_spark_sliced_services_std_display_renderers_core_platform_html_Away3DHtmlRenderer();
	tools_spark_sliced_core_Sliced.display.platformRendererSet.set("3D",v1);
	v1;
};
tools_spark_framework_platform_html_away3d_Subgraphics.init = function() {
	tools_spark_framework_platform_html_away3d_Subgraphics._flambeDisplaySystem = flambe_platform_html_HtmlPlatform.instance.getRenderer();
	tools_spark_framework_platform_html_away3d_Subgraphics._initProxies();
};
tools_spark_framework_platform_html_away3d_Subgraphics.initAway3DStage3DgetContext3D = function() {
						...
						;
	tools_spark_framework_Console.info("away html init!");
	var l_view3D = new away.containers.View3D();
	l_view3D.shareContext = true;
	l_view3D.layeredView = true;
	tools_spark_framework_platform_html_away3d_Subgraphics._stage3DManager = away.managers.Stage3DManager.getInstance(l_view3D.stage);
	tools_spark_framework_platform_html_away3d_Subgraphics._stage3DProxy = tools_spark_framework_platform_html_away3d_Subgraphics._stage3DManager.getStage3DProxy(0);
	tools_spark_framework_Console.info("away html rendering away: " + tools_spark_framework_platform_html_away3d_Subgraphics._stage3DManager.numProxySlotsUsed);
	l_view3D.dispose();
	tools_spark_framework_Console.info("away html rendering away: " + tools_spark_framework_platform_html_away3d_Subgraphics._stage3DManager.numProxySlotsUsed);
	return tools_spark_framework_platform_html_away3d_Subgraphics._stage3DProxy.stage3D.context3D.gl();
};
tools_spark_framework_platform_html_away3d_Subgraphics._initProxies = function() {
	tools_spark_framework_platform_html_away3d_Subgraphics._stage3DProxy.antiAlias = 8;
	tools_spark_framework_platform_html_away3d_Subgraphics._stage3DProxy.color = 16711680;
	var reqAnimFrame = new away.utils.RequestAnimationFrame(tools_spark_framework_platform_html_away3d_Subgraphics._onAwayEnterFrame,tools_spark_framework_platform_html_away3d_Subgraphics);
	reqAnimFrame.start();
};
tools_spark_framework_platform_html_away3d_Subgraphics._onAwayEnterFrame = function(p1) {
	if(tools_spark_sliced_core_Sliced.display == null) return;
	if(tools_spark_sliced_core_Sliced.display.projectActiveSpaceReference == null) return;
	if(tools_spark_sliced_core_Sliced.display.projectActiveSpaceReference.activeStageReference == null) return;
	var htmlrenderer;
	htmlrenderer = js_Boot.__cast(tools_spark_framework_platform_html_away3d_Subgraphics._flambeDisplaySystem , flambe_platform_html_WebGLRenderer);
	var batcher = htmlrenderer.batcher;
	tools_spark_framework_platform_html_away3d_Subgraphics._flambeDisplaySystem.willRender();
	var _g = 0;
	...
	while(_g < _g1.length) {
		...
		++_g;
		tools_spark_framework_platform_html_away3d_Subgraphics._flambeDisplaySystem.didRender();
...
var tools_spark_sliced_services_std_display_managers_core_Away3DCameraManager = function(p_renderer) {
	this._renderer = p_renderer;
};
$hxClasses["tools.spark.sliced.services.std.display.managers.core.Away3DCameraManager"] = tools_spark_sliced_services_std_display_managers_core_Away3DCameraManager;
tools_spark_sliced_services_std_display_managers_core_Away3DCameraManager.__name__ = true;
tools_spark_sliced_services_std_display_managers_core_Away3DCameraManager.__interfaces__ = [tools_spark_sliced_services_std_display_managers_interfaces_IDisplayObjectManager];
tools_spark_sliced_services_std_display_managers_core_Away3DCameraManager.prototype = {
	create: function(p_gameEntity) {
		var l_camera3D = new away.cameras.Camera3D();
		l_camera3D.x = 450;
		l_camera3D.z -= 700;
		return l_camera3D;
	}
	...
	,__class__: tools_spark_sliced_services_std_display_managers_core_Away3DCameraManager
};
var tools_spark_sliced_services_std_display_managers_core_Away3DObjectManager = function(p_renderer) {
	this._renderer = p_renderer;
};
$hxClasses["tools.spark.sliced.services.std.display.managers.core.Away3DObjectManager"] = tools_spark_sliced_services_std_display_managers_core_Away3DObjectManager;
tools_spark_sliced_services_std_display_managers_core_Away3DObjectManager.__name__ = true;
tools_spark_sliced_services_std_display_managers_core_Away3DObjectManager.__interfaces__ = [tools_spark_sliced_services_std_display_managers_interfaces_IDisplayObjectManager];
tools_spark_sliced_services_std_display_managers_core_Away3DObjectManager.prototype = {
	create: function(p_gameEntity) {
		var l_object3D = new away.containers.ObjectContainer3D();
		var l_geometry = new away.primitives.CubeGeometry(500,500,500);
		var l_material = new away.materials.ColorMaterial(Std["int"](Math.random() * (13421772 - 10000) + 10000));
		l_material.lightPicker = tools_spark_sliced_services_std_display_managers_core_Away3DSceneManager._deleteMeMainLightpicker;
		var l_mesh = new away.entities.Mesh(l_geometry,l_material);
		l_object3D.addChild(l_mesh);
		this.update(l_object3D,p_gameEntity);
		return l_object3D;
	}
	,update: function(p_object,p_gameEntity) {
		this.updateState(p_object,p_gameEntity,"spaceX");
		this.updateState(p_object,p_gameEntity,"spaceY");
		this.updateState(p_object,p_gameEntity,"spaceZ");
	}
	,updateState: function(p_object,p_gameEntity,p_state) {
		switch(p_state) {
		case "spaceX":
	...
	,__class__: tools_spark_sliced_services_std_display_managers_core_Away3DObjectManager
};
var tools_spark_sliced_services_std_display_managers_core_Away3DSceneManager = function(p_renderer) {
	this._renderer = p_renderer;
};
$hxClasses["tools.spark.sliced.services.std.display.managers.core.Away3DSceneManager"] = tools_spark_sliced_services_std_display_managers_core_Away3DSceneManager;
tools_spark_sliced_services_std_display_managers_core_Away3DSceneManager.__name__ = true;
tools_spark_sliced_services_std_display_managers_core_Away3DSceneManager.__interfaces__ = [tools_spark_sliced_services_std_display_managers_interfaces_IDisplayObjectManager];
tools_spark_sliced_services_std_display_managers_core_Away3DSceneManager.prototype = {
	create: function(p_gameEntity) {
		var l_scene3D = new away.containers.Scene3D();
		this._deletemeCreateLight(l_scene3D);
		this.update(l_scene3D,p_gameEntity);
		return l_scene3D;
	}
	,update: function(p_object,p_gameEntity) {
		var _g = 0;
		...
		while(_g < _g1.length) {
			var f_childEntity = _g1[_g];
			++_g;
			this.addTo(this._renderer.createObject(f_childEntity),p_object);
		}
	}
	,updateState: function(p_object,p_gameEntity,p_state) {
	}
	,addTo: function(p_objectChild,p_objectParent) {
		var l_scene3D;
		l_scene3D = js_Boot.__cast(p_objectParent , away.containers.Scene3D);
		if(p_objectChild != null) l_scene3D.addChild(p_objectChild);
	}
	,_deletemeCreateLight: function(p_scene) {
		var directionalLight = new away.lights.DirectionalLight();
		directionalLight.ambientColor = 16777215;
		...
		this._deleteMeMainLight = directionalLight;
		tools_spark_sliced_services_std_display_managers_core_Away3DSceneManager._deleteMeMainLightpicker = new away.materials.StaticLightPicker([this._deleteMeMainLight]);
	}
	,__class__: tools_spark_sliced_services_std_display_managers_core_Away3DSceneManager
};
var tools_spark_sliced_services_std_display_managers_core_Away3DViewManager = function(p_renderer) {
	this._renderer = p_renderer;
};
$hxClasses["tools.spark.sliced.services.std.display.managers.core.Away3DViewManager"] = tools_spark_sliced_services_std_display_managers_core_Away3DViewManager;
tools_spark_sliced_services_std_display_managers_core_Away3DViewManager.__name__ = true;
tools_spark_sliced_services_std_display_managers_core_Away3DViewManager.__interfaces__ = [tools_spark_sliced_services_std_display_managers_interfaces_IDisplayObjectManager];
tools_spark_sliced_services_std_display_managers_core_Away3DViewManager.prototype = {
	create: function(p_gameEntity) {
		var l_view3D = new away.containers.View3D();
		var l_group = tools_spark_sliced_core_Sliced.display.projectActiveSpaceReference.activeStageReference.layoutManager.getViewGroupByGameEntity(p_gameEntity);
		l_group.layoutableInstance = this;
		var stage3Dmanager = away.managers.Stage3DManager.getInstance(l_view3D.stage);
		l_view3D.stage3DProxy = stage3Dmanager.getStage3DProxy(0);
		l_view3D.shareContext = true;
		l_view3D.layeredView = true;
		tools_spark_framework_Console.error("CREATED VIEW 3D WITH A GROUP ON THE VIEW MANAGER!!");
		tools_spark_framework_Console.info("away html new view created. Num of Stage3DProxies: " + stage3Dmanager.numProxySlotsUsed);
		stage3Dmanager.iRemoveStage3DProxy(stage3Dmanager.getStage3DProxy(1));
		tools_spark_framework_Console.info("away html view removed. Num of Stage3DProxies: " + stage3Dmanager.numProxySlotsUsed);
		this.update(l_view3D,p_gameEntity);
		return l_view3D;
	}
	,update: function(p_object,p_gameEntity) {
	...
	,updateState: function(p_object,p_gameEntity,p_state) {
		...
		case "scene":
			...
			p_object.scene = this._renderer.createScene(l_sceneEntity);
			break;
		case "camera":
			var l_cameraEntity = p_gameEntity.getState(p_state);
			p_object.camera = this._renderer.createCamera(l_cameraEntity);
			break;
		}
	}
	,__class__: tools_spark_sliced_services_std_display_managers_core_Away3DViewManager
};
...
var tools_spark_sliced_services_std_display_renderers_core_dimension_A3DRenderer = function() {
	tools_spark_sliced_services_std_display_renderers_core_ARenderer.call(this);
	this._a3DRendererInit();
};
$hxClasses["tools.spark.sliced.services.std.display.renderers.core.dimension.A3DRenderer"] = tools_spark_sliced_services_std_display_renderers_core_dimension_A3DRenderer;
tools_spark_sliced_services_std_display_renderers_core_dimension_A3DRenderer.__name__ = true;
tools_spark_sliced_services_std_display_renderers_core_dimension_A3DRenderer.__interfaces__ = [tools_spark_sliced_services_std_display_renderers_interfaces_IDimensionSpecificRenderer];
tools_spark_sliced_services_std_display_renderers_core_dimension_A3DRenderer.__super__ = tools_spark_sliced_services_std_display_renderers_core_ARenderer;
tools_spark_sliced_services_std_display_renderers_core_dimension_A3DRenderer.prototype = $extend(tools_spark_sliced_services_std_display_renderers_core_ARenderer.prototype,{
	_a3DRendererInit: function() {
	}
	,__class__: tools_spark_sliced_services_std_display_renderers_core_dimension_A3DRenderer
});
...
var tools_spark_sliced_services_std_display_renderers_core_library_AAway3DRenderer = function() {
	tools_spark_sliced_services_std_display_renderers_core_dimension_A3DRenderer.call(this);
	this._aAway3dRendererInit();
};
$hxClasses["tools.spark.sliced.services.std.display.renderers.core.library.AAway3DRenderer"] = tools_spark_sliced_services_std_display_renderers_core_library_AAway3DRenderer;
tools_spark_sliced_services_std_display_renderers_core_library_AAway3DRenderer.__name__ = true;
tools_spark_sliced_services_std_display_renderers_core_library_AAway3DRenderer.__interfaces__ = [tools_spark_sliced_services_std_display_renderers_interfaces_ILibrarySpecificRenderer];
tools_spark_sliced_services_std_display_renderers_core_library_AAway3DRenderer.__super__ = tools_spark_sliced_services_std_display_renderers_core_dimension_A3DRenderer;
tools_spark_sliced_services_std_display_renderers_core_library_AAway3DRenderer.prototype = $extend(tools_spark_sliced_services_std_display_renderers_core_dimension_A3DRenderer.prototype,{
	_aAway3dRendererInit: function() {
		...
		this._viewManager = new tools_spark_sliced_services_std_display_managers_core_Away3DViewManager(this);
		this._sceneManager = new tools_spark_sliced_services_std_display_managers_core_Away3DSceneManager(this);
		this._cameraManager = new tools_spark_sliced_services_std_display_managers_core_Away3DCameraManager(this);
		this._objectManager = new tools_spark_sliced_services_std_display_managers_core_Away3DObjectManager(this);
	}
	,renderView: function(p_viewEntity) {
		this._views.get(p_viewEntity).render();
	}
	,createView: function(p_viewEntity) {
		if(this._views.get(p_viewEntity) != null) tools_spark_framework_Console.warn("View " + Std.string(p_viewEntity.getState("name")) + " has already been added to this Away3DRenderer. Ignoring..."); else {
			var v;
			v = js_Boot.__cast(this._viewManager.create(p_viewEntity) , away.containers.View3D);
	...
	,createScene: function(p_sceneEntity) {
		if(this._scenes.get(p_sceneEntity) != null) tools_spark_framework_Console.warn("Scene " + Std.string(p_sceneEntity.getState("name")) + " has already been added to this Away3DRenderer. Ignoring..."); else {
			var v;
			v = js_Boot.__cast(this._sceneManager.create(p_sceneEntity) , away.containers.Scene3D);
	...
	,createCamera: function(p_cameraEntity) {
		if(this._cameras.get(p_cameraEntity) != null) tools_spark_framework_Console.warn("Camera " + Std.string(p_cameraEntity.getState("name")) + " has already been added to this Away3DRenderer. Ignoring..."); else {
			var v;
			v = js_Boot.__cast(this._cameraManager.create(p_cameraEntity) , away.cameras.Camera3D);
	...
	,createObject: function(p_objectEntity) {
		if(p_objectEntity.getState("displayType") == "Entity") {
			if(this._objects.get(p_objectEntity) != null) tools_spark_framework_Console.warn("Object " + Std.string(p_objectEntity.getState("name")) + " has already been added to this Away3DRenderer. Ignoring..."); else {
				var v;
				v = js_Boot.__cast(this._objectManager.create(p_objectEntity) , away.containers.ObjectContainer3D);
	...
	,addChild: function(p_parentEntity,p_childEntity) {
		...
		case "Entity":
			...
			break;
		default:
			tools_spark_framework_Console.warn("AAway3DRenderer: Unhandled add child request: " + Std.string(p_parentEntity.getState("displayType")));
		}
	}
	...
	,__class__: tools_spark_sliced_services_std_display_renderers_core_library_AAway3DRenderer
});
...
var tools_spark_sliced_services_std_display_renderers_core_platform_html_Away3DHtmlRenderer = function() {
	tools_spark_sliced_services_std_display_renderers_core_library_AAway3DRenderer.call(this);
	this._away3DHtmlRendererInit();
};
$hxClasses["tools.spark.sliced.services.std.display.renderers.core.platform.html.Away3DHtmlRenderer"] = tools_spark_sliced_services_std_display_renderers_core_platform_html_Away3DHtmlRenderer;
tools_spark_sliced_services_std_display_renderers_core_platform_html_Away3DHtmlRenderer.__name__ = true;
tools_spark_sliced_services_std_display_renderers_core_platform_html_Away3DHtmlRenderer.__interfaces__ = [tools_spark_sliced_services_std_display_renderers_interfaces_IPlatformSpecificRenderer];
tools_spark_sliced_services_std_display_renderers_core_platform_html_Away3DHtmlRenderer.__super__ = tools_spark_sliced_services_std_display_renderers_core_library_AAway3DRenderer;
tools_spark_sliced_services_std_display_renderers_core_platform_html_Away3DHtmlRenderer.prototype = $extend(tools_spark_sliced_services_std_display_renderers_core_library_AAway3DRenderer.prototype,{
	_away3DHtmlRendererInit: function() {
		tools_spark_framework_Console.info("Creating Away3D Html Renderer...");
	}
	,__class__: tools_spark_sliced_services_std_display_renderers_core_platform_html_Away3DHtmlRenderer
});
...
tools_spark_sliced_services_std_event_core_Event.prototype = $extend(tools_spark_sliced_core_AService.prototype,{
	...
	,_initPrefabConvertToTypeMap: function() {
		...
		v11;
		var v12 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.MOUSE_LEFT;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT,v12);
		v12;
		var v13 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED,v13);
		v13;
		var v14 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED,v14);
		v14;
		var v15 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ALT,v15);
		v15;
		var v16 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSPACE,v16);
		v16;
		var v17 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CAPS_LOCK,v17);
		v17;
		var v18 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CONTROL,v18);
		v18;
		var v19 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DELETE,v19);
		v19;
		var v20 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DOWN,v20);
		v20;
		var v21 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_END,v21);
		v21;
		var v22 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ENTER,v22);
		v22;
		var v23 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ESCAPE,v23);
		v23;
		var v24 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F1,v24);
		v24;
		var v25 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F10,v25);
		v25;
		var v26 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F11,v26);
		v26;
		var v27 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F12,v27);
		v27;
		var v28 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F13,v28);
		v28;
		var v29 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F14,v29);
		v29;
		var v30 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F15,v30);
		v30;
		var v31 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F2,v31);
		v31;
		var v32 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F3,v32);
		v32;
		var v33 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F4,v33);
		v33;
		var v34 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F5,v34);
		v34;
		var v35 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F6,v35);
		v35;
		var v36 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F7,v36);
		v36;
		var v37 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F8,v37);
		v37;
		var v38 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F9,v38);
		v38;
		var v39 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_HOME,v39);
		v39;
		var v40 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_INSERT,v40);
		v40;
		var v41 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFT,v41);
		v41;
		var v42 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_0,v42);
		v42;
		var v43 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_1,v43);
		v43;
		var v44 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_2,v44);
		v44;
		var v45 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_3,v45);
		v45;
		var v46 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_4,v46);
		v46;
		var v47 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_5,v47);
		v47;
		var v48 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_6,v48);
		v48;
		var v49 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_7,v49);
		v49;
		var v50 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_8,v50);
		v50;
		var v51 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_9,v51);
		v51;
		var v52 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ADD,v52);
		v52;
		var v53 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DECIMAL,v53);
		v53;
		var v54 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DIVIDE,v54);
		v54;
		var v55 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ENTER,v55);
		v55;
		var v56 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_MULTIPLY,v56);
		v56;
		var v57 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_SUBTRACT,v57);
		v57;
		var v58 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_DOWN,v58);
		v58;
		var v59 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_UP,v59);
		v59;
		var v60 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHT,v60);
		v60;
		var v61 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SHIFT,v61);
		v61;
		var v62 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SPACE,v62);
		v62;
		var v63 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_TAB,v63);
		v63;
		var v64 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UP,v64);
		v64;
		var v65 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_A,v65);
		v65;
		var v66 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_B,v66);
		v66;
		var v67 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_C,v67);
		v67;
		var v68 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_D,v68);
		v68;
		var v69 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_E,v69);
		v69;
		var v70 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F,v70);
		v70;
		var v71 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_G,v71);
		v71;
		var v72 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_H,v72);
		v72;
		var v73 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_I,v73);
		v73;
		var v74 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_J,v74);
		v74;
		var v75 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_K,v75);
		v75;
		var v76 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_L,v76);
		v76;
		var v77 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_M,v77);
		v77;
		var v78 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_N,v78);
		v78;
		var v79 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_O,v79);
		v79;
		var v80 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_P,v80);
		v80;
		var v81 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Q,v81);
		v81;
		var v82 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_R,v82);
		v82;
		var v83 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_S,v83);
		v83;
		var v84 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_T,v84);
		v84;
		var v85 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_U,v85);
		v85;
		var v86 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_V,v86);
		v86;
		var v87 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_W,v87);
		v87;
		var v88 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_X,v88);
		v88;
		var v89 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Y,v89);
		v89;
		var v90 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Z,v90);
		v90;
		var v91 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_0,v91);
		v91;
		var v92 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_1,v92);
		v92;
		var v93 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_2,v93);
		v93;
		var v94 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_3,v94);
		v94;
		var v95 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_4,v95);
		v95;
		var v96 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_5,v96);
		v96;
		var v97 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_6,v97);
		v97;
		var v98 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_7,v98);
		v98;
		var v99 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_8,v99);
		v99;
		var v100 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_9,v100);
		v100;
		var v101 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_EQUALS,v101);
		v101;
		var v102 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SLASH,v102);
		v102;
		var v103 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSLASH,v103);
		v103;
		var v104 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFTBRACKET,v104);
		v104;
		var v105 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHTBRACKET,v105);
		v105;
		var v106 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKQUOTE,v106);
		v106;
		var v107 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMA,v107);
		v107;
		var v108 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMAND,v108);
		v108;
		var v109 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_MINUS,v109);
		v109;
		var v110 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PERIOD,v110);
		v110;
		var v111 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_QUOTE,v111);
		v111;
		var v112 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SEMICOLON,v112);
		v112;
		var v113 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDMENU,v113);
		v113;
		var v114 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDSEARCH,v114);
		v114;
		var v115 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UNKNOWN,v115);
		v115;
		var v116 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ALT,v116);
		v116;
		var v117 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSPACE,v117);
		v117;
		var v118 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CAPS_LOCK,v118);
		v118;
		var v119 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CONTROL,v119);
		v119;
		var v120 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DELETE,v120);
		v120;
		var v121 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DOWN,v121);
		v121;
		var v122 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_END,v122);
		v122;
		var v123 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ENTER,v123);
		v123;
		var v124 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ESCAPE,v124);
		v124;
		var v125 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F1,v125);
		v125;
		var v126 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F10,v126);
		v126;
		var v127 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F11,v127);
		v127;
		var v128 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F12,v128);
		v128;
		var v129 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F13,v129);
		v129;
		var v130 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F14,v130);
		v130;
		var v131 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F15,v131);
		v131;
		var v132 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F2,v132);
		v132;
		var v133 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F3,v133);
		v133;
		var v134 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F4,v134);
		v134;
		var v135 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F5,v135);
		v135;
		var v136 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F6,v136);
		v136;
		var v137 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F7,v137);
		v137;
		var v138 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F8,v138);
		v138;
		var v139 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F9,v139);
		v139;
		var v140 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_HOME,v140);
		v140;
		var v141 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_INSERT,v141);
		v141;
		var v142 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFT,v142);
		v142;
		var v143 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_0,v143);
		v143;
		var v144 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_1,v144);
		v144;
		var v145 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_2,v145);
		v145;
		var v146 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_3,v146);
		v146;
		var v147 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_4,v147);
		v147;
		var v148 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_5,v148);
		v148;
		var v149 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_6,v149);
		v149;
		var v150 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_7,v150);
		v150;
		var v151 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_8,v151);
		v151;
		var v152 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_9,v152);
		v152;
		var v153 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ADD,v153);
		v153;
		var v154 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DECIMAL,v154);
		v154;
		var v155 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DIVIDE,v155);
		v155;
		var v156 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ENTER,v156);
		v156;
		var v157 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_MULTIPLY,v157);
		v157;
		var v158 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_SUBTRACT,v158);
		v158;
		var v159 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_DOWN,v159);
		v159;
		var v160 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_UP,v160);
		v160;
		var v161 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHT,v161);
		v161;
		var v162 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SHIFT,v162);
		v162;
		var v163 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SPACE,v163);
		v163;
		var v164 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_TAB,v164);
		v164;
		var v165 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UP,v165);
		v165;
		var v166 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_A,v166);
		v166;
		var v167 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_B,v167);
		v167;
		var v168 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_C,v168);
		v168;
		var v169 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_D,v169);
		v169;
		var v170 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_E,v170);
		v170;
		var v171 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F,v171);
		v171;
		var v172 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_G,v172);
		v172;
		var v173 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_H,v173);
		v173;
		var v174 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_I,v174);
		v174;
		var v175 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_J,v175);
		v175;
		var v176 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_K,v176);
		v176;
		var v177 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_L,v177);
		v177;
		var v178 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_M,v178);
		v178;
		var v179 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_N,v179);
		v179;
		var v180 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_O,v180);
		v180;
		var v181 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_P,v181);
		v181;
		var v182 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Q,v182);
		v182;
		var v183 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_R,v183);
		v183;
		var v184 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_S,v184);
		v184;
		var v185 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_T,v185);
		v185;
		var v186 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_U,v186);
		v186;
		var v187 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_V,v187);
		v187;
		var v188 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_W,v188);
		v188;
		var v189 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_X,v189);
		v189;
		var v190 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Y,v190);
		v190;
		var v191 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Z,v191);
		v191;
		var v192 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_0,v192);
		v192;
		var v193 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_1,v193);
		v193;
		var v194 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_2,v194);
		v194;
		var v195 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_3,v195);
		v195;
		var v196 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_4,v196);
		v196;
		var v197 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_5,v197);
		v197;
		var v198 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_6,v198);
		v198;
		var v199 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_7,v199);
		v199;
		var v200 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_8,v200);
		v200;
		var v201 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_9,v201);
		v201;
		var v202 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_EQUALS,v202);
		v202;
		var v203 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SLASH,v203);
		v203;
		var v204 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSLASH,v204);
		v204;
		var v205 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFTBRACKET,v205);
		v205;
		var v206 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHTBRACKET,v206);
		v206;
		var v207 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKQUOTE,v207);
		v207;
		var v208 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMA,v208);
		v208;
		var v209 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMAND,v209);
		v209;
		var v210 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_MINUS,v210);
		v210;
		var v211 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PERIOD,v211);
		v211;
		var v212 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_QUOTE,v212);
		v212;
		var v213 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SEMICOLON,v213);
		v213;
		var v214 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDMENU,v214);
		v214;
		var v215 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDSEARCH,v215);
		v215;
		var v216 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED;
		this._prefabConvertToType.set(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UNKNOWN,v216);
		v216;
	}
...
tools_spark_sliced_services_std_logic_gde_core_GameClassParser.prototype = {
	...
	,_initEventNameToPrefabMap: function() {
		...
		v11;
		var k12 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT);
		var v12 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT;
		this._xmlEventNameToPrefab.set(k12,v12);
		v12;
		var k13 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED);
		var v13 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED;
		this._xmlEventNameToPrefab.set(k13,v13);
		v13;
		var k14 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED);
		var v14 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED;
		this._xmlEventNameToPrefab.set(k14,v14);
		v14;
		var k15 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ALT);
		var v15 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ALT;
		this._xmlEventNameToPrefab.set(k15,v15);
		v15;
		var k16 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSPACE);
		var v16 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSPACE;
		this._xmlEventNameToPrefab.set(k16,v16);
		v16;
		var k17 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CAPS_LOCK);
		var v17 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CAPS_LOCK;
		this._xmlEventNameToPrefab.set(k17,v17);
		v17;
		var k18 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CONTROL);
		var v18 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CONTROL;
		this._xmlEventNameToPrefab.set(k18,v18);
		v18;
		var k19 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DELETE);
		var v19 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DELETE;
		this._xmlEventNameToPrefab.set(k19,v19);
		v19;
		var k20 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DOWN);
		var v20 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DOWN;
		this._xmlEventNameToPrefab.set(k20,v20);
		v20;
		var k21 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_END);
		var v21 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_END;
		this._xmlEventNameToPrefab.set(k21,v21);
		v21;
		var k22 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ENTER);
		var v22 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ENTER;
		this._xmlEventNameToPrefab.set(k22,v22);
		v22;
		var k23 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ESCAPE);
		var v23 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ESCAPE;
		this._xmlEventNameToPrefab.set(k23,v23);
		v23;
		var k24 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F1);
		var v24 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F1;
		this._xmlEventNameToPrefab.set(k24,v24);
		v24;
		var k25 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F10);
		var v25 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F10;
		this._xmlEventNameToPrefab.set(k25,v25);
		v25;
		var k26 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F11);
		var v26 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F11;
		this._xmlEventNameToPrefab.set(k26,v26);
		v26;
		var k27 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F12);
		var v27 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F12;
		this._xmlEventNameToPrefab.set(k27,v27);
		v27;
		var k28 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F13);
		var v28 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F13;
		this._xmlEventNameToPrefab.set(k28,v28);
		v28;
		var k29 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F14);
		var v29 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F14;
		this._xmlEventNameToPrefab.set(k29,v29);
		v29;
		var k30 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F15);
		var v30 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F15;
		this._xmlEventNameToPrefab.set(k30,v30);
		v30;
		var k31 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F2);
		var v31 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F2;
		this._xmlEventNameToPrefab.set(k31,v31);
		v31;
		var k32 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F3);
		var v32 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F3;
		this._xmlEventNameToPrefab.set(k32,v32);
		v32;
		var k33 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F4);
		var v33 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F4;
		this._xmlEventNameToPrefab.set(k33,v33);
		v33;
		var k34 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F5);
		var v34 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F5;
		this._xmlEventNameToPrefab.set(k34,v34);
		v34;
		var k35 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F6);
		var v35 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F6;
		this._xmlEventNameToPrefab.set(k35,v35);
		v35;
		var k36 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F7);
		var v36 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F7;
		this._xmlEventNameToPrefab.set(k36,v36);
		v36;
		var k37 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F8);
		var v37 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F8;
		this._xmlEventNameToPrefab.set(k37,v37);
		v37;
		var k38 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F9);
		var v38 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F9;
		this._xmlEventNameToPrefab.set(k38,v38);
		v38;
		var k39 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_HOME);
		var v39 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_HOME;
		this._xmlEventNameToPrefab.set(k39,v39);
		v39;
		var k40 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_INSERT);
		var v40 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_INSERT;
		this._xmlEventNameToPrefab.set(k40,v40);
		v40;
		var k41 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFT);
		var v41 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFT;
		this._xmlEventNameToPrefab.set(k41,v41);
		v41;
		var k42 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_0);
		var v42 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_0;
		this._xmlEventNameToPrefab.set(k42,v42);
		v42;
		var k43 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_1);
		var v43 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_1;
		this._xmlEventNameToPrefab.set(k43,v43);
		v43;
		var k44 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_2);
		var v44 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_2;
		this._xmlEventNameToPrefab.set(k44,v44);
		v44;
		var k45 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_3);
		var v45 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_3;
		this._xmlEventNameToPrefab.set(k45,v45);
		v45;
		var k46 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_4);
		var v46 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_4;
		this._xmlEventNameToPrefab.set(k46,v46);
		v46;
		var k47 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_5);
		var v47 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_5;
		this._xmlEventNameToPrefab.set(k47,v47);
		v47;
		var k48 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_6);
		var v48 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_6;
		this._xmlEventNameToPrefab.set(k48,v48);
		v48;
		var k49 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_7);
		var v49 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_7;
		this._xmlEventNameToPrefab.set(k49,v49);
		v49;
		var k50 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_8);
		var v50 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_8;
		this._xmlEventNameToPrefab.set(k50,v50);
		v50;
		var k51 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_9);
		var v51 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_9;
		this._xmlEventNameToPrefab.set(k51,v51);
		v51;
		var k52 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ADD);
		var v52 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ADD;
		this._xmlEventNameToPrefab.set(k52,v52);
		v52;
		var k53 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DECIMAL);
		var v53 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DECIMAL;
		this._xmlEventNameToPrefab.set(k53,v53);
		v53;
		var k54 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DIVIDE);
		var v54 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DIVIDE;
		this._xmlEventNameToPrefab.set(k54,v54);
		v54;
		var k55 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ENTER);
		var v55 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ENTER;
		this._xmlEventNameToPrefab.set(k55,v55);
		v55;
		var k56 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_MULTIPLY);
		var v56 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_MULTIPLY;
		this._xmlEventNameToPrefab.set(k56,v56);
		v56;
		var k57 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_SUBTRACT);
		var v57 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_SUBTRACT;
		this._xmlEventNameToPrefab.set(k57,v57);
		v57;
		var k58 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_DOWN);
		var v58 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_DOWN;
		this._xmlEventNameToPrefab.set(k58,v58);
		v58;
		var k59 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_UP);
		var v59 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_UP;
		this._xmlEventNameToPrefab.set(k59,v59);
		v59;
		var k60 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHT);
		var v60 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHT;
		this._xmlEventNameToPrefab.set(k60,v60);
		v60;
		var k61 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SHIFT);
		var v61 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SHIFT;
		this._xmlEventNameToPrefab.set(k61,v61);
		v61;
		var k62 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SPACE);
		var v62 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SPACE;
		this._xmlEventNameToPrefab.set(k62,v62);
		v62;
		var k63 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_TAB);
		var v63 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_TAB;
		this._xmlEventNameToPrefab.set(k63,v63);
		v63;
		var k64 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UP);
		var v64 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UP;
		this._xmlEventNameToPrefab.set(k64,v64);
		v64;
		var k65 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_A);
		var v65 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_A;
		this._xmlEventNameToPrefab.set(k65,v65);
		v65;
		var k66 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_B);
		var v66 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_B;
		this._xmlEventNameToPrefab.set(k66,v66);
		v66;
		var k67 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_C);
		var v67 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_C;
		this._xmlEventNameToPrefab.set(k67,v67);
		v67;
		var k68 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_D);
		var v68 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_D;
		this._xmlEventNameToPrefab.set(k68,v68);
		v68;
		var k69 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_E);
		var v69 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_E;
		this._xmlEventNameToPrefab.set(k69,v69);
		v69;
		var k70 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F);
		var v70 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F;
		this._xmlEventNameToPrefab.set(k70,v70);
		v70;
		var k71 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_G);
		var v71 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_G;
		this._xmlEventNameToPrefab.set(k71,v71);
		v71;
		var k72 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_H);
		var v72 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_H;
		this._xmlEventNameToPrefab.set(k72,v72);
		v72;
		var k73 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_I);
		var v73 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_I;
		this._xmlEventNameToPrefab.set(k73,v73);
		v73;
		var k74 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_J);
		var v74 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_J;
		this._xmlEventNameToPrefab.set(k74,v74);
		v74;
		var k75 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_K);
		var v75 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_K;
		this._xmlEventNameToPrefab.set(k75,v75);
		v75;
		var k76 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_L);
		var v76 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_L;
		this._xmlEventNameToPrefab.set(k76,v76);
		v76;
		var k77 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_M);
		var v77 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_M;
		this._xmlEventNameToPrefab.set(k77,v77);
		v77;
		var k78 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_N);
		var v78 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_N;
		this._xmlEventNameToPrefab.set(k78,v78);
		v78;
		var k79 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_O);
		var v79 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_O;
		this._xmlEventNameToPrefab.set(k79,v79);
		v79;
		var k80 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_P);
		var v80 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_P;
		this._xmlEventNameToPrefab.set(k80,v80);
		v80;
		var k81 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Q);
		var v81 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Q;
		this._xmlEventNameToPrefab.set(k81,v81);
		v81;
		var k82 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_R);
		var v82 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_R;
		this._xmlEventNameToPrefab.set(k82,v82);
		v82;
		var k83 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_S);
		var v83 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_S;
		this._xmlEventNameToPrefab.set(k83,v83);
		v83;
		var k84 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_T);
		var v84 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_T;
		this._xmlEventNameToPrefab.set(k84,v84);
		v84;
		var k85 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_U);
		var v85 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_U;
		this._xmlEventNameToPrefab.set(k85,v85);
		v85;
		var k86 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_V);
		var v86 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_V;
		this._xmlEventNameToPrefab.set(k86,v86);
		v86;
		var k87 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_W);
		var v87 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_W;
		this._xmlEventNameToPrefab.set(k87,v87);
		v87;
		var k88 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_X);
		var v88 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_X;
		this._xmlEventNameToPrefab.set(k88,v88);
		v88;
		var k89 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Y);
		var v89 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Y;
		this._xmlEventNameToPrefab.set(k89,v89);
		v89;
		var k90 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Z);
		var v90 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Z;
		this._xmlEventNameToPrefab.set(k90,v90);
		v90;
		var k91 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_0);
		var v91 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_0;
		this._xmlEventNameToPrefab.set(k91,v91);
		v91;
		var k92 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_1);
		var v92 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_1;
		this._xmlEventNameToPrefab.set(k92,v92);
		v92;
		var k93 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_2);
		var v93 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_2;
		this._xmlEventNameToPrefab.set(k93,v93);
		v93;
		var k94 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_3);
		var v94 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_3;
		this._xmlEventNameToPrefab.set(k94,v94);
		v94;
		var k95 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_4);
		var v95 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_4;
		this._xmlEventNameToPrefab.set(k95,v95);
		v95;
		var k96 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_5);
		var v96 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_5;
		this._xmlEventNameToPrefab.set(k96,v96);
		v96;
		var k97 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_6);
		var v97 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_6;
		this._xmlEventNameToPrefab.set(k97,v97);
		v97;
		var k98 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_7);
		var v98 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_7;
		this._xmlEventNameToPrefab.set(k98,v98);
		v98;
		var k99 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_8);
		var v99 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_8;
		this._xmlEventNameToPrefab.set(k99,v99);
		v99;
		var k100 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_9);
		var v100 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_9;
		this._xmlEventNameToPrefab.set(k100,v100);
		v100;
		var k101 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_EQUALS);
		var v101 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_EQUALS;
		this._xmlEventNameToPrefab.set(k101,v101);
		v101;
		var k102 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SLASH);
		var v102 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SLASH;
		this._xmlEventNameToPrefab.set(k102,v102);
		v102;
		var k103 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSLASH);
		var v103 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSLASH;
		this._xmlEventNameToPrefab.set(k103,v103);
		v103;
		var k104 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFTBRACKET);
		var v104 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFTBRACKET;
		this._xmlEventNameToPrefab.set(k104,v104);
		v104;
		var k105 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHTBRACKET);
		var v105 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHTBRACKET;
		this._xmlEventNameToPrefab.set(k105,v105);
		v105;
		var k106 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKQUOTE);
		var v106 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKQUOTE;
		this._xmlEventNameToPrefab.set(k106,v106);
		v106;
		var k107 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMA);
		var v107 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMA;
		this._xmlEventNameToPrefab.set(k107,v107);
		v107;
		var k108 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMAND);
		var v108 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMAND;
		this._xmlEventNameToPrefab.set(k108,v108);
		v108;
		var k109 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_MINUS);
		var v109 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_MINUS;
		this._xmlEventNameToPrefab.set(k109,v109);
		v109;
		var k110 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PERIOD);
		var v110 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PERIOD;
		this._xmlEventNameToPrefab.set(k110,v110);
		v110;
		var k111 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_QUOTE);
		var v111 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_QUOTE;
		this._xmlEventNameToPrefab.set(k111,v111);
		v111;
		var k112 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SEMICOLON);
		var v112 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SEMICOLON;
		this._xmlEventNameToPrefab.set(k112,v112);
		v112;
		var k113 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDMENU);
		var v113 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDMENU;
		this._xmlEventNameToPrefab.set(k113,v113);
		v113;
		var k114 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDSEARCH);
		var v114 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDSEARCH;
		this._xmlEventNameToPrefab.set(k114,v114);
		v114;
		var k115 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UNKNOWN);
		var v115 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UNKNOWN;
		this._xmlEventNameToPrefab.set(k115,v115);
		v115;
		var k116 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ALT);
		var v116 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ALT;
		this._xmlEventNameToPrefab.set(k116,v116);
		v116;
		var k117 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSPACE);
		var v117 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSPACE;
		this._xmlEventNameToPrefab.set(k117,v117);
		v117;
		var k118 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CAPS_LOCK);
		var v118 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CAPS_LOCK;
		this._xmlEventNameToPrefab.set(k118,v118);
		v118;
		var k119 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CONTROL);
		var v119 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CONTROL;
		this._xmlEventNameToPrefab.set(k119,v119);
		v119;
		var k120 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DELETE);
		var v120 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DELETE;
		this._xmlEventNameToPrefab.set(k120,v120);
		v120;
		var k121 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DOWN);
		var v121 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DOWN;
		this._xmlEventNameToPrefab.set(k121,v121);
		v121;
		var k122 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_END);
		var v122 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_END;
		this._xmlEventNameToPrefab.set(k122,v122);
		v122;
		var k123 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ENTER);
		var v123 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ENTER;
		this._xmlEventNameToPrefab.set(k123,v123);
		v123;
		var k124 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ESCAPE);
		var v124 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ESCAPE;
		this._xmlEventNameToPrefab.set(k124,v124);
		v124;
		var k125 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F1);
		var v125 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F1;
		this._xmlEventNameToPrefab.set(k125,v125);
		v125;
		var k126 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F10);
		var v126 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F10;
		this._xmlEventNameToPrefab.set(k126,v126);
		v126;
		var k127 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F11);
		var v127 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F11;
		this._xmlEventNameToPrefab.set(k127,v127);
		v127;
		var k128 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F12);
		var v128 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F12;
		this._xmlEventNameToPrefab.set(k128,v128);
		v128;
		var k129 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F13);
		var v129 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F13;
		this._xmlEventNameToPrefab.set(k129,v129);
		v129;
		var k130 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F14);
		var v130 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F14;
		this._xmlEventNameToPrefab.set(k130,v130);
		v130;
		var k131 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F15);
		var v131 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F15;
		this._xmlEventNameToPrefab.set(k131,v131);
		v131;
		var k132 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F2);
		var v132 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F2;
		this._xmlEventNameToPrefab.set(k132,v132);
		v132;
		var k133 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F3);
		var v133 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F3;
		this._xmlEventNameToPrefab.set(k133,v133);
		v133;
		var k134 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F4);
		var v134 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F4;
		this._xmlEventNameToPrefab.set(k134,v134);
		v134;
		var k135 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F5);
		var v135 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F5;
		this._xmlEventNameToPrefab.set(k135,v135);
		v135;
		var k136 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F6);
		var v136 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F6;
		this._xmlEventNameToPrefab.set(k136,v136);
		v136;
		var k137 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F7);
		var v137 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F7;
		this._xmlEventNameToPrefab.set(k137,v137);
		v137;
		var k138 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F8);
		var v138 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F8;
		this._xmlEventNameToPrefab.set(k138,v138);
		v138;
		var k139 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F9);
		var v139 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F9;
		this._xmlEventNameToPrefab.set(k139,v139);
		v139;
		var k140 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_HOME);
		var v140 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_HOME;
		this._xmlEventNameToPrefab.set(k140,v140);
		v140;
		var k141 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_INSERT);
		var v141 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_INSERT;
		this._xmlEventNameToPrefab.set(k141,v141);
		v141;
		var k142 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFT);
		var v142 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFT;
		this._xmlEventNameToPrefab.set(k142,v142);
		v142;
		var k143 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_0);
		var v143 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_0;
		this._xmlEventNameToPrefab.set(k143,v143);
		v143;
		var k144 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_1);
		var v144 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_1;
		this._xmlEventNameToPrefab.set(k144,v144);
		v144;
		var k145 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_2);
		var v145 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_2;
		this._xmlEventNameToPrefab.set(k145,v145);
		v145;
		var k146 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_3);
		var v146 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_3;
		this._xmlEventNameToPrefab.set(k146,v146);
		v146;
		var k147 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_4);
		var v147 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_4;
		this._xmlEventNameToPrefab.set(k147,v147);
		v147;
		var k148 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_5);
		var v148 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_5;
		this._xmlEventNameToPrefab.set(k148,v148);
		v148;
		var k149 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_6);
		var v149 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_6;
		this._xmlEventNameToPrefab.set(k149,v149);
		v149;
		var k150 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_7);
		var v150 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_7;
		this._xmlEventNameToPrefab.set(k150,v150);
		v150;
		var k151 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_8);
		var v151 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_8;
		this._xmlEventNameToPrefab.set(k151,v151);
		v151;
		var k152 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_9);
		var v152 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_9;
		this._xmlEventNameToPrefab.set(k152,v152);
		v152;
		var k153 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ADD);
		var v153 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ADD;
		this._xmlEventNameToPrefab.set(k153,v153);
		v153;
		var k154 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DECIMAL);
		var v154 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DECIMAL;
		this._xmlEventNameToPrefab.set(k154,v154);
		v154;
		var k155 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DIVIDE);
		var v155 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DIVIDE;
		this._xmlEventNameToPrefab.set(k155,v155);
		v155;
		var k156 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ENTER);
		var v156 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ENTER;
		this._xmlEventNameToPrefab.set(k156,v156);
		v156;
		var k157 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_MULTIPLY);
		var v157 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_MULTIPLY;
		this._xmlEventNameToPrefab.set(k157,v157);
		v157;
		var k158 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_SUBTRACT);
		var v158 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_SUBTRACT;
		this._xmlEventNameToPrefab.set(k158,v158);
		v158;
		var k159 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_DOWN);
		var v159 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_DOWN;
		this._xmlEventNameToPrefab.set(k159,v159);
		v159;
		var k160 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_UP);
		var v160 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_UP;
		this._xmlEventNameToPrefab.set(k160,v160);
		v160;
		var k161 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHT);
		var v161 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHT;
		this._xmlEventNameToPrefab.set(k161,v161);
		v161;
		var k162 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SHIFT);
		var v162 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SHIFT;
		this._xmlEventNameToPrefab.set(k162,v162);
		v162;
		var k163 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SPACE);
		var v163 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SPACE;
		this._xmlEventNameToPrefab.set(k163,v163);
		v163;
		var k164 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_TAB);
		var v164 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_TAB;
		this._xmlEventNameToPrefab.set(k164,v164);
		v164;
		var k165 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UP);
		var v165 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UP;
		this._xmlEventNameToPrefab.set(k165,v165);
		v165;
		var k166 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_A);
		var v166 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_A;
		this._xmlEventNameToPrefab.set(k166,v166);
		v166;
		var k167 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_B);
		var v167 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_B;
		this._xmlEventNameToPrefab.set(k167,v167);
		v167;
		var k168 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_C);
		var v168 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_C;
		this._xmlEventNameToPrefab.set(k168,v168);
		v168;
		var k169 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_D);
		var v169 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_D;
		this._xmlEventNameToPrefab.set(k169,v169);
		v169;
		var k170 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_E);
		var v170 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_E;
		this._xmlEventNameToPrefab.set(k170,v170);
		v170;
		var k171 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F);
		var v171 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F;
		this._xmlEventNameToPrefab.set(k171,v171);
		v171;
		var k172 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_G);
		var v172 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_G;
		this._xmlEventNameToPrefab.set(k172,v172);
		v172;
		var k173 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_H);
		var v173 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_H;
		this._xmlEventNameToPrefab.set(k173,v173);
		v173;
		var k174 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_I);
		var v174 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_I;
		this._xmlEventNameToPrefab.set(k174,v174);
		v174;
		var k175 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_J);
		var v175 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_J;
		this._xmlEventNameToPrefab.set(k175,v175);
		v175;
		var k176 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_K);
		var v176 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_K;
		this._xmlEventNameToPrefab.set(k176,v176);
		v176;
		var k177 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_L);
		var v177 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_L;
		this._xmlEventNameToPrefab.set(k177,v177);
		v177;
		var k178 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_M);
		var v178 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_M;
		this._xmlEventNameToPrefab.set(k178,v178);
		v178;
		var k179 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_N);
		var v179 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_N;
		this._xmlEventNameToPrefab.set(k179,v179);
		v179;
		var k180 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_O);
		var v180 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_O;
		this._xmlEventNameToPrefab.set(k180,v180);
		v180;
		var k181 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_P);
		var v181 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_P;
		this._xmlEventNameToPrefab.set(k181,v181);
		v181;
		var k182 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Q);
		var v182 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Q;
		this._xmlEventNameToPrefab.set(k182,v182);
		v182;
		var k183 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_R);
		var v183 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_R;
		this._xmlEventNameToPrefab.set(k183,v183);
		v183;
		var k184 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_S);
		var v184 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_S;
		this._xmlEventNameToPrefab.set(k184,v184);
		v184;
		var k185 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_T);
		var v185 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_T;
		this._xmlEventNameToPrefab.set(k185,v185);
		v185;
		var k186 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_U);
		var v186 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_U;
		this._xmlEventNameToPrefab.set(k186,v186);
		v186;
		var k187 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_V);
		var v187 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_V;
		this._xmlEventNameToPrefab.set(k187,v187);
		v187;
		var k188 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_W);
		var v188 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_W;
		this._xmlEventNameToPrefab.set(k188,v188);
		v188;
		var k189 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_X);
		var v189 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_X;
		this._xmlEventNameToPrefab.set(k189,v189);
		v189;
		var k190 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Y);
		var v190 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Y;
		this._xmlEventNameToPrefab.set(k190,v190);
		v190;
		var k191 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Z);
		var v191 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Z;
		this._xmlEventNameToPrefab.set(k191,v191);
		v191;
		var k192 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_0);
		var v192 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_0;
		this._xmlEventNameToPrefab.set(k192,v192);
		v192;
		var k193 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_1);
		var v193 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_1;
		this._xmlEventNameToPrefab.set(k193,v193);
		v193;
		var k194 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_2);
		var v194 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_2;
		this._xmlEventNameToPrefab.set(k194,v194);
		v194;
		var k195 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_3);
		var v195 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_3;
		this._xmlEventNameToPrefab.set(k195,v195);
		v195;
		var k196 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_4);
		var v196 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_4;
		this._xmlEventNameToPrefab.set(k196,v196);
		v196;
		var k197 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_5);
		var v197 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_5;
		this._xmlEventNameToPrefab.set(k197,v197);
		v197;
		var k198 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_6);
		var v198 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_6;
		this._xmlEventNameToPrefab.set(k198,v198);
		v198;
		var k199 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_7);
		var v199 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_7;
		this._xmlEventNameToPrefab.set(k199,v199);
		v199;
		var k200 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_8);
		var v200 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_8;
		this._xmlEventNameToPrefab.set(k200,v200);
		v200;
		var k201 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_9);
		var v201 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_9;
		this._xmlEventNameToPrefab.set(k201,v201);
		v201;
		var k202 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_EQUALS);
		var v202 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_EQUALS;
		this._xmlEventNameToPrefab.set(k202,v202);
		v202;
		var k203 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SLASH);
		var v203 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SLASH;
		this._xmlEventNameToPrefab.set(k203,v203);
		v203;
		var k204 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSLASH);
		var v204 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSLASH;
		this._xmlEventNameToPrefab.set(k204,v204);
		v204;
		var k205 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFTBRACKET);
		var v205 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFTBRACKET;
		this._xmlEventNameToPrefab.set(k205,v205);
		v205;
		var k206 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHTBRACKET);
		var v206 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHTBRACKET;
		this._xmlEventNameToPrefab.set(k206,v206);
		v206;
		var k207 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKQUOTE);
		var v207 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKQUOTE;
		this._xmlEventNameToPrefab.set(k207,v207);
		v207;
		var k208 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMA);
		var v208 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMA;
		this._xmlEventNameToPrefab.set(k208,v208);
		v208;
		var k209 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMAND);
		var v209 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMAND;
		this._xmlEventNameToPrefab.set(k209,v209);
		v209;
		var k210 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_MINUS);
		var v210 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_MINUS;
		this._xmlEventNameToPrefab.set(k210,v210);
		v210;
		var k211 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PERIOD);
		var v211 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PERIOD;
		this._xmlEventNameToPrefab.set(k211,v211);
		v211;
		var k212 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_QUOTE);
		var v212 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_QUOTE;
		this._xmlEventNameToPrefab.set(k212,v212);
		v212;
		var k213 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SEMICOLON);
		var v213 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SEMICOLON;
		this._xmlEventNameToPrefab.set(k213,v213);
		v213;
		var k214 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDMENU);
		var v214 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDMENU;
		this._xmlEventNameToPrefab.set(k214,v214);
		v214;
		var k215 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDSEARCH);
		var v215 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDSEARCH;
		this._xmlEventNameToPrefab.set(k215,v215);
		v215;
		var k216 = this._xmlEventPrefabToName.get(tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UNKNOWN);
		var v216 = tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UNKNOWN;
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.MOUSE_LEFT = ["MOUSE_LEFT",12];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED = ["KEY_PRESSED",13];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED = ["KEY_RELEASED",14];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ALT = ["KEY_PRESSED_ALT",15];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSPACE = ["KEY_PRESSED_BACKSPACE",16];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CAPS_LOCK = ["KEY_PRESSED_CAPS_LOCK",17];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_CONTROL = ["KEY_PRESSED_CONTROL",18];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DELETE = ["KEY_PRESSED_DELETE",19];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_DOWN = ["KEY_PRESSED_DOWN",20];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_END = ["KEY_PRESSED_END",21];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ENTER = ["KEY_PRESSED_ENTER",22];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ESCAPE = ["KEY_PRESSED_ESCAPE",23];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F1 = ["KEY_PRESSED_F1",24];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F10 = ["KEY_PRESSED_F10",25];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F11 = ["KEY_PRESSED_F11",26];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F12 = ["KEY_PRESSED_F12",27];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F13 = ["KEY_PRESSED_F13",28];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F14 = ["KEY_PRESSED_F14",29];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F15 = ["KEY_PRESSED_F15",30];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F2 = ["KEY_PRESSED_F2",31];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F3 = ["KEY_PRESSED_F3",32];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F4 = ["KEY_PRESSED_F4",33];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F5 = ["KEY_PRESSED_F5",34];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F6 = ["KEY_PRESSED_F6",35];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F7 = ["KEY_PRESSED_F7",36];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F8 = ["KEY_PRESSED_F8",37];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F9 = ["KEY_PRESSED_F9",38];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_HOME = ["KEY_PRESSED_HOME",39];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_INSERT = ["KEY_PRESSED_INSERT",40];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFT = ["KEY_PRESSED_LEFT",41];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_0 = ["KEY_PRESSED_NUMPAD_0",42];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_1 = ["KEY_PRESSED_NUMPAD_1",43];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_2 = ["KEY_PRESSED_NUMPAD_2",44];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_3 = ["KEY_PRESSED_NUMPAD_3",45];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_4 = ["KEY_PRESSED_NUMPAD_4",46];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_5 = ["KEY_PRESSED_NUMPAD_5",47];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_6 = ["KEY_PRESSED_NUMPAD_6",48];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_7 = ["KEY_PRESSED_NUMPAD_7",49];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_8 = ["KEY_PRESSED_NUMPAD_8",50];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_9 = ["KEY_PRESSED_NUMPAD_9",51];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ADD = ["KEY_PRESSED_NUMPAD_ADD",52];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DECIMAL = ["KEY_PRESSED_NUMPAD_DECIMAL",53];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_DIVIDE = ["KEY_PRESSED_NUMPAD_DIVIDE",54];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_ENTER = ["KEY_PRESSED_NUMPAD_ENTER",55];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_MULTIPLY = ["KEY_PRESSED_NUMPAD_MULTIPLY",56];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMPAD_SUBTRACT = ["KEY_PRESSED_NUMPAD_SUBTRACT",57];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_DOWN = ["KEY_PRESSED_PAGE_DOWN",58];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PAGE_UP = ["KEY_PRESSED_PAGE_UP",59];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHT = ["KEY_PRESSED_RIGHT",60];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SHIFT = ["KEY_PRESSED_SHIFT",61];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SPACE = ["KEY_PRESSED_SPACE",62];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_TAB = ["KEY_PRESSED_TAB",63];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UP = ["KEY_PRESSED_UP",64];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_A = ["KEY_PRESSED_A",65];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_B = ["KEY_PRESSED_B",66];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_C = ["KEY_PRESSED_C",67];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_D = ["KEY_PRESSED_D",68];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_E = ["KEY_PRESSED_E",69];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_F = ["KEY_PRESSED_F",70];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_G = ["KEY_PRESSED_G",71];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_H = ["KEY_PRESSED_H",72];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_I = ["KEY_PRESSED_I",73];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_J = ["KEY_PRESSED_J",74];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_K = ["KEY_PRESSED_K",75];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_L = ["KEY_PRESSED_L",76];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_M = ["KEY_PRESSED_M",77];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_N = ["KEY_PRESSED_N",78];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_O = ["KEY_PRESSED_O",79];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_P = ["KEY_PRESSED_P",80];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Q = ["KEY_PRESSED_Q",81];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_R = ["KEY_PRESSED_R",82];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_S = ["KEY_PRESSED_S",83];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_T = ["KEY_PRESSED_T",84];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_U = ["KEY_PRESSED_U",85];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_V = ["KEY_PRESSED_V",86];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_W = ["KEY_PRESSED_W",87];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_X = ["KEY_PRESSED_X",88];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Y = ["KEY_PRESSED_Y",89];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_Z = ["KEY_PRESSED_Z",90];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_0 = ["KEY_PRESSED_NUMBER_0",91];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_1 = ["KEY_PRESSED_NUMBER_1",92];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_2 = ["KEY_PRESSED_NUMBER_2",93];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_3 = ["KEY_PRESSED_NUMBER_3",94];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_4 = ["KEY_PRESSED_NUMBER_4",95];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_5 = ["KEY_PRESSED_NUMBER_5",96];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_6 = ["KEY_PRESSED_NUMBER_6",97];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_7 = ["KEY_PRESSED_NUMBER_7",98];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_8 = ["KEY_PRESSED_NUMBER_8",99];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_NUMBER_9 = ["KEY_PRESSED_NUMBER_9",100];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_EQUALS = ["KEY_PRESSED_EQUALS",101];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SLASH = ["KEY_PRESSED_SLASH",102];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKSLASH = ["KEY_PRESSED_BACKSLASH",103];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_LEFTBRACKET = ["KEY_PRESSED_LEFTBRACKET",104];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_RIGHTBRACKET = ["KEY_PRESSED_RIGHTBRACKET",105];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_BACKQUOTE = ["KEY_PRESSED_BACKQUOTE",106];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMA = ["KEY_PRESSED_COMMA",107];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_COMMAND = ["KEY_PRESSED_COMMAND",108];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_MINUS = ["KEY_PRESSED_MINUS",109];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_PERIOD = ["KEY_PRESSED_PERIOD",110];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_QUOTE = ["KEY_PRESSED_QUOTE",111];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_SEMICOLON = ["KEY_PRESSED_SEMICOLON",112];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDMENU = ["KEY_PRESSED_ANDROIDMENU",113];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_ANDROIDSEARCH = ["KEY_PRESSED_ANDROIDSEARCH",114];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_PRESSED_UNKNOWN = ["KEY_PRESSED_UNKNOWN",115];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ALT = ["KEY_RELEASED_ALT",116];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSPACE = ["KEY_RELEASED_BACKSPACE",117];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CAPS_LOCK = ["KEY_RELEASED_CAPS_LOCK",118];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_CONTROL = ["KEY_RELEASED_CONTROL",119];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DELETE = ["KEY_RELEASED_DELETE",120];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_DOWN = ["KEY_RELEASED_DOWN",121];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_END = ["KEY_RELEASED_END",122];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ENTER = ["KEY_RELEASED_ENTER",123];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ESCAPE = ["KEY_RELEASED_ESCAPE",124];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F1 = ["KEY_RELEASED_F1",125];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F10 = ["KEY_RELEASED_F10",126];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F11 = ["KEY_RELEASED_F11",127];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F12 = ["KEY_RELEASED_F12",128];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F13 = ["KEY_RELEASED_F13",129];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F14 = ["KEY_RELEASED_F14",130];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F15 = ["KEY_RELEASED_F15",131];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F2 = ["KEY_RELEASED_F2",132];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F3 = ["KEY_RELEASED_F3",133];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F4 = ["KEY_RELEASED_F4",134];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F5 = ["KEY_RELEASED_F5",135];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F6 = ["KEY_RELEASED_F6",136];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F7 = ["KEY_RELEASED_F7",137];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F8 = ["KEY_RELEASED_F8",138];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F9 = ["KEY_RELEASED_F9",139];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_HOME = ["KEY_RELEASED_HOME",140];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_INSERT = ["KEY_RELEASED_INSERT",141];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFT = ["KEY_RELEASED_LEFT",142];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_0 = ["KEY_RELEASED_NUMPAD_0",143];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_1 = ["KEY_RELEASED_NUMPAD_1",144];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_2 = ["KEY_RELEASED_NUMPAD_2",145];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_3 = ["KEY_RELEASED_NUMPAD_3",146];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_4 = ["KEY_RELEASED_NUMPAD_4",147];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_5 = ["KEY_RELEASED_NUMPAD_5",148];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_6 = ["KEY_RELEASED_NUMPAD_6",149];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_7 = ["KEY_RELEASED_NUMPAD_7",150];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_8 = ["KEY_RELEASED_NUMPAD_8",151];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_9 = ["KEY_RELEASED_NUMPAD_9",152];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ADD = ["KEY_RELEASED_NUMPAD_ADD",153];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DECIMAL = ["KEY_RELEASED_NUMPAD_DECIMAL",154];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_DIVIDE = ["KEY_RELEASED_NUMPAD_DIVIDE",155];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_ENTER = ["KEY_RELEASED_NUMPAD_ENTER",156];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_MULTIPLY = ["KEY_RELEASED_NUMPAD_MULTIPLY",157];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMPAD_SUBTRACT = ["KEY_RELEASED_NUMPAD_SUBTRACT",158];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_DOWN = ["KEY_RELEASED_PAGE_DOWN",159];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PAGE_UP = ["KEY_RELEASED_PAGE_UP",160];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHT = ["KEY_RELEASED_RIGHT",161];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SHIFT = ["KEY_RELEASED_SHIFT",162];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SPACE = ["KEY_RELEASED_SPACE",163];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_TAB = ["KEY_RELEASED_TAB",164];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UP = ["KEY_RELEASED_UP",165];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_A = ["KEY_RELEASED_A",166];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_B = ["KEY_RELEASED_B",167];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_C = ["KEY_RELEASED_C",168];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_D = ["KEY_RELEASED_D",169];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_E = ["KEY_RELEASED_E",170];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_F = ["KEY_RELEASED_F",171];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_G = ["KEY_RELEASED_G",172];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_H = ["KEY_RELEASED_H",173];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_I = ["KEY_RELEASED_I",174];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_J = ["KEY_RELEASED_J",175];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_K = ["KEY_RELEASED_K",176];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_L = ["KEY_RELEASED_L",177];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_M = ["KEY_RELEASED_M",178];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_N = ["KEY_RELEASED_N",179];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_O = ["KEY_RELEASED_O",180];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_P = ["KEY_RELEASED_P",181];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Q = ["KEY_RELEASED_Q",182];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_R = ["KEY_RELEASED_R",183];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_S = ["KEY_RELEASED_S",184];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_T = ["KEY_RELEASED_T",185];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_U = ["KEY_RELEASED_U",186];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_V = ["KEY_RELEASED_V",187];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_W = ["KEY_RELEASED_W",188];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_X = ["KEY_RELEASED_X",189];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Y = ["KEY_RELEASED_Y",190];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_Z = ["KEY_RELEASED_Z",191];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_0 = ["KEY_RELEASED_NUMBER_0",192];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_1 = ["KEY_RELEASED_NUMBER_1",193];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_2 = ["KEY_RELEASED_NUMBER_2",194];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_3 = ["KEY_RELEASED_NUMBER_3",195];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_4 = ["KEY_RELEASED_NUMBER_4",196];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_5 = ["KEY_RELEASED_NUMBER_5",197];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_6 = ["KEY_RELEASED_NUMBER_6",198];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_7 = ["KEY_RELEASED_NUMBER_7",199];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_8 = ["KEY_RELEASED_NUMBER_8",200];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_NUMBER_9 = ["KEY_RELEASED_NUMBER_9",201];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_EQUALS = ["KEY_RELEASED_EQUALS",202];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SLASH = ["KEY_RELEASED_SLASH",203];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKSLASH = ["KEY_RELEASED_BACKSLASH",204];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_LEFTBRACKET = ["KEY_RELEASED_LEFTBRACKET",205];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_RIGHTBRACKET = ["KEY_RELEASED_RIGHTBRACKET",206];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_BACKQUOTE = ["KEY_RELEASED_BACKQUOTE",207];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMA = ["KEY_RELEASED_COMMA",208];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_COMMAND = ["KEY_RELEASED_COMMAND",209];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_MINUS = ["KEY_RELEASED_MINUS",210];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_PERIOD = ["KEY_RELEASED_PERIOD",211];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_QUOTE = ["KEY_RELEASED_QUOTE",212];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_SEMICOLON = ["KEY_RELEASED_SEMICOLON",213];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDMENU = ["KEY_RELEASED_ANDROIDMENU",214];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_ANDROIDSEARCH = ["KEY_RELEASED_ANDROIDSEARCH",215];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventPrefab.KEY_RELEASED_UNKNOWN = ["KEY_RELEASED_UNKNOWN",216];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.MOUSE_LEFT = ["MOUSE_LEFT",10];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_PRESSED = ["KEY_PRESSED",11];
...
tools_spark_sliced_services_std_logic_gde_interfaces_EEventType.KEY_RELEASED = ["KEY_RELEASED",12];
...
tools_spark_sliced_services_std_logic_interpreter_core_HaxeInterpreter.prototype = {
	_init: function() {
		...
		this._interpreter.variables.set("Framework",tools_spark_framework_Framework);
