...
tools_spark_framework_dom2_$5D_DomEntity2_$5D.prototype = $extend(tools_spark_framework_space2_$5D_core_AEntity2_$5D.prototype,{
	_initDomEntity2_5D: function() {
		...
		v3;
		var v4 = $bind(this,this._updateDisplay);
		this._updateStateFunctions.set("display",v4);
		v4;
		var v5 = $bind(this,this._updateText);
		this._updateStateFunctions.set("text",v5);
		v5;
	}
	,createInstance: function(p_view2_5D) {
	...
	,_updateText: function(p_text,p_view2_5D) {
		if(p_text != "Undefined") {
			...
			switch(_g) {
			case "Div":
				this._instances.get(p_view2_5D).innerText = p_text;
				break;
			case "Input":
